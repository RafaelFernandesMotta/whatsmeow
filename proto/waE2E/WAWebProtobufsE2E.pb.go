...
const (
	MsgOpaqueData_UNKNOWN MsgOpaqueData_PollContentType = 0
	MsgOpaqueData_TEXT    MsgOpaqueData_PollContentType = 1
	MsgOpaqueData_IMAGE   MsgOpaqueData_PollContentType = 2
)

// Enum value maps for MsgOpaqueData_PollContentType.
var (
	MsgOpaqueData_PollContentType_name = map[int32]string{
		0: "UNKNOWN",
		1: "TEXT",
		2: "IMAGE",
	}
	MsgOpaqueData_PollContentType_value = map[string]int32{
		"UNKNOWN": 0,
		"TEXT":    1,
		"IMAGE":   2,
	}
...
func (x MsgOpaqueData_PollContentType) Enum() *MsgOpaqueData_PollContentType {
	p := new(MsgOpaqueData_PollContentType)
	*p = x
	return p
}

func (x MsgOpaqueData_PollContentType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (MsgOpaqueData_PollContentType) Descriptor() protoreflect.EnumDescriptor {
	return file_waE2E_WAWebProtobufsE2E_proto_enumTypes[69].Descriptor()
}

func (MsgOpaqueData_PollContentType) Type() protoreflect.EnumType {
	return &file_waE2E_WAWebProtobufsE2E_proto_enumTypes[69]
}

func (x MsgOpaqueData_PollContentType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Do not use.
func (x *MsgOpaqueData_PollContentType) UnmarshalJSON(b []byte) error {
	num, err := protoimpl.X.UnmarshalJSONEnum(x.Descriptor(), b)
	if err != nil {
		return err
	}
	*x = MsgOpaqueData_PollContentType(num)
	return nil
}
...
const (
	MsgOpaqueData_POLL MsgOpaqueData_PollType = 0
	MsgOpaqueData_QUIZ MsgOpaqueData_PollType = 1
)

// Enum value maps for MsgOpaqueData_PollType.
var (
	MsgOpaqueData_PollType_name = map[int32]string{
		0: "POLL",
		1: "QUIZ",
	}
	MsgOpaqueData_PollType_value = map[string]int32{
		"POLL": 0,
		"QUIZ": 1,
	}
)

func (x MsgOpaqueData_PollType) Enum() *MsgOpaqueData_PollType {
	p := new(MsgOpaqueData_PollType)
	*p = x
	return p
}

func (x MsgOpaqueData_PollType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (MsgOpaqueData_PollType) Descriptor() protoreflect.EnumDescriptor {
	return file_waE2E_WAWebProtobufsE2E_proto_enumTypes[70].Descriptor()
}

func (MsgOpaqueData_PollType) Type() protoreflect.EnumType {
	return &file_waE2E_WAWebProtobufsE2E_proto_enumTypes[70]
}

func (x MsgOpaqueData_PollType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Do not use.
func (x *MsgOpaqueData_PollType) UnmarshalJSON(b []byte) error {
	num, err := protoimpl.X.UnmarshalJSONEnum(x.Descriptor(), b)
	if err != nil {
		return err
	}
	*x = MsgOpaqueData_PollType(num)
	return nil
}

// Deprecated: Use MsgOpaqueData_PollType.Descriptor instead.
func (MsgOpaqueData_PollType) EnumDescriptor() ([]byte, []int) {
	return file_waE2E_WAWebProtobufsE2E_proto_rawDescGZIP(), []int{111, 1}
}
...
type MsgOpaqueData struct {
	...
	PollContentType             *MsgOpaqueData_PollContentType   `protobuf:"varint,42,opt,name=pollContentType,enum=WAWebProtobufsE2E.MsgOpaqueData_PollContentType" json:"pollContentType,omitempty"`
	PollType                    *MsgOpaqueData_PollType          `protobuf:"varint,46,opt,name=pollType,enum=WAWebProtobufsE2E.MsgOpaqueData_PollType" json:"pollType,omitempty"`
	CorrectOptionIndex          *int32                           `protobuf:"varint,47,opt,name=correctOptionIndex" json:"correctOptionIndex,omitempty"`
	PollVotesSnapshot           *MsgOpaqueData_PollVotesSnapshot `protobuf:"bytes,41,opt,name=pollVotesSnapshot" json:"pollVotesSnapshot,omitempty"`
	...
	EventName                   *string                          `protobuf:"bytes,33,opt,name=eventName" json:"eventName,omitempty"`
	IsEventCanceled             *bool                            `protobuf:"varint,34,opt,name=isEventCanceled" json:"isEventCanceled,omitempty"`
	EventDescription            *string                          `protobuf:"bytes,35,opt,name=eventDescription" json:"eventDescription,omitempty"`
	EventJoinLink               *string                          `protobuf:"bytes,36,opt,name=eventJoinLink" json:"eventJoinLink,omitempty"`
	EventStartTime              *int64                           `protobuf:"varint,37,opt,name=eventStartTime" json:"eventStartTime,omitempty"`
	EventLocation               *MsgOpaqueData_EventLocation     `protobuf:"bytes,38,opt,name=eventLocation" json:"eventLocation,omitempty"`
	EventEndTime                *int64                           `protobuf:"varint,40,opt,name=eventEndTime" json:"eventEndTime,omitempty"`
	EventIsScheduledCall        *bool                            `protobuf:"varint,44,opt,name=eventIsScheduledCall" json:"eventIsScheduledCall,omitempty"`
	EventExtraGuestsAllowed     *bool                            `protobuf:"varint,45,opt,name=eventExtraGuestsAllowed" json:"eventExtraGuestsAllowed,omitempty"`
	PlainProtobufBytes          []byte                           `protobuf:"bytes,43,opt,name=plainProtobufBytes" json:"plainProtobufBytes,omitempty"`
	QuarantineExtractedText     *string                          `protobuf:"bytes,48,opt,name=quarantineExtractedText" json:"quarantineExtractedText,omitempty"`
	PollEndTime                 *int64                           `protobuf:"varint,49,opt,name=pollEndTime" json:"pollEndTime,omitempty"`
	PollHideVoterNames          *bool                            `protobuf:"varint,50,opt,name=pollHideVoterNames" json:"pollHideVoterNames,omitempty"`
	unknownFields               protoimpl.UnknownFields
	sizeCache                   protoimpl.SizeCache
}
...
func (x *MsgOpaqueData) GetPollContentType() MsgOpaqueData_PollContentType {
	if x != nil && x.PollContentType != nil {
		return *x.PollContentType
	}
	return MsgOpaqueData_UNKNOWN
}

func (x *MsgOpaqueData) GetPollType() MsgOpaqueData_PollType {
	if x != nil && x.PollType != nil {
		return *x.PollType
	}
	return MsgOpaqueData_POLL
}

func (x *MsgOpaqueData) GetCorrectOptionIndex() int32 {
	if x != nil && x.CorrectOptionIndex != nil {
		return *x.CorrectOptionIndex
	}
	return 0
}

func (x *MsgOpaqueData) GetPollVotesSnapshot() *MsgOpaqueData_PollVotesSnapshot {
	if x != nil {
		return x.PollVotesSnapshot
	}
	return nil
}
...
func (x *MsgOpaqueData) GetEventName() string {
...
func (x *MsgOpaqueData) GetIsEventCanceled() bool {
	if x != nil && x.IsEventCanceled != nil {
		return *x.IsEventCanceled
	}
	return false
}

func (x *MsgOpaqueData) GetEventDescription() string {
...
func (x *MsgOpaqueData) GetEventJoinLink() string {
	if x != nil && x.EventJoinLink != nil {
		return *x.EventJoinLink
	}
	return ""
}

func (x *MsgOpaqueData) GetEventStartTime() int64 {
	if x != nil && x.EventStartTime != nil {
		return *x.EventStartTime
	}
	return 0
}

func (x *MsgOpaqueData) GetEventLocation() *MsgOpaqueData_EventLocation {
	if x != nil {
...
func (x *MsgOpaqueData) GetEventEndTime() int64 {
	if x != nil && x.EventEndTime != nil {
		return *x.EventEndTime
	}
	return 0
}

func (x *MsgOpaqueData) GetEventIsScheduledCall() bool {
	if x != nil && x.EventIsScheduledCall != nil {
		return *x.EventIsScheduledCall
	}
	return false
}

func (x *MsgOpaqueData) GetEventExtraGuestsAllowed() bool {
	if x != nil && x.EventExtraGuestsAllowed != nil {
		return *x.EventExtraGuestsAllowed
	}
	return false
}

func (x *MsgOpaqueData) GetPlainProtobufBytes() []byte {
	if x != nil {
		return x.PlainProtobufBytes
	}
	return nil
}

func (x *MsgOpaqueData) GetQuarantineExtractedText() string {
	if x != nil && x.QuarantineExtractedText != nil {
		return *x.QuarantineExtractedText
	}
	return ""
}

func (x *MsgOpaqueData) GetPollEndTime() int64 {
	if x != nil && x.PollEndTime != nil {
		return *x.PollEndTime
	}
	return 0
}

func (x *MsgOpaqueData) GetPollHideVoterNames() bool {
	if x != nil && x.PollHideVoterNames != nil {
		return *x.PollHideVoterNames
	}
	return false
}
...
type MsgOpaqueData_EventLocation struct {
	...
	Address          *string                `protobuf:"bytes,4,opt,name=address" json:"address,omitempty"`
	Url              *string                `protobuf:"bytes,5,opt,name=url" json:"url,omitempty"`
	JpegThumbnail    []byte                 `protobuf:"bytes,6,opt,name=jpegThumbnail" json:"jpegThumbnail,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *MsgOpaqueData_EventLocation) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *MsgOpaqueData_EventLocation) GetDegreesLongitude() float64 {
	if x != nil && x.DegreesLongitude != nil {
		return *x.DegreesLongitude
	}
	return 0
...
func (x *MsgOpaqueData_EventLocation) GetName() string {
	if x != nil && x.Name != nil {
		return *x.Name
	}
	return ""
...
func (x *MsgOpaqueData_EventLocation) GetAddress() string {
	if x != nil && x.Address != nil {
		return *x.Address
	}
	return ""
...
func (x *MsgOpaqueData_EventLocation) GetUrl() string {
	if x != nil && x.Url != nil {
		return *x.Url
	}
	return ""
...
func (x *MsgOpaqueData_EventLocation) GetJpegThumbnail() []byte {
	if x != nil {
		return x.JpegThumbnail
	}
	return nil
...
func (x *MsgOpaqueData_PollOption) GetHash() string {
	if x != nil && x.Hash != nil {
		return *x.Hash
	}
	return ""
...
type MsgOpaqueData_PollVoteSnapshot struct {
	state           protoimpl.MessageState    `protogen:"open.v1"`
	Option          *MsgOpaqueData_PollOption `protobuf:"bytes,1,opt,name=option" json:"option,omitempty"`
	OptionVoteCount *int32                    `protobuf:"varint,2,opt,name=optionVoteCount" json:"optionVoteCount,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *MsgOpaqueData_PollVoteSnapshot) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (*MsgOpaqueData_PollVoteSnapshot) Descriptor() ([]byte, []int) {
	return file_waE2E_WAWebProtobufsE2E_proto_rawDescGZIP(), []int{111, 2}
}
...
func (x *MsgOpaqueData_PollVoteSnapshot) GetOptionVoteCount() int32 {
	if x != nil && x.OptionVoteCount != nil {
		return *x.OptionVoteCount
	}
	return 0
...
type MsgOpaqueData_PollVotesSnapshot struct {
	state         protoimpl.MessageState            `protogen:"open.v1"`
	PollVotes     []*MsgOpaqueData_PollVoteSnapshot `protobuf:"bytes,1,rep,name=pollVotes" json:"pollVotes,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *MsgOpaqueData_PollVotesSnapshot) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (*MsgOpaqueData_PollVotesSnapshot) Descriptor() ([]byte, []int) {
	return file_waE2E_WAWebProtobufsE2E_proto_rawDescGZIP(), []int{111, 3}
}
...
const file_waE2E_WAWebProtobufsE2E_proto_rawDesc = "" +
	...
	"\x1ainteractiveResponseMessage\"\xa7\x14\n" +
	...
	"\x04type\x18\x03 \x01(\tR\x04typeB\x14\n" +
	...
	"\x16flowResponsesCsvBundle\x18\v \x01(\v2i.WAWebProtobufsE2E.PeerDataOperationRequestResponseMessage.PeerDataOperationResult.FlowResponsesCsvBundleR\x16flowResponsesCsvBundle\x1a\xd8\x02\n" +
	...
	"\x05nonce\x18\x01 \x01(\tR\x05nonce\x1a\xfa\x02\n" +
	...
	"\x12DOWNLOAD_RESPONSES\x10\x02\x1a\xda\x01\n" +
	...
	"\x13registrationTraceId\x18\x01 \x01(\tR\x13registrationTraceId\"\xb4\x01\n" +
	...
	"\fcurrencyCode\x18\x03 \x01(\tR\fcurrencyCode\"\xf9\x14\n" +
	"\rMsgOpaqueData\x12\x12\n" +
	"\x04body\x18\x01 \x01(\tR\x04body\x12\x18\n" +
	"\acaption\x18\x03 \x01(\tR\acaption\x12\x10\n" +
	"\x03lng\x18\x05 \x01(\x01R\x03lng\x12\x16\n" +
	"\x06isLive\x18\x06 \x01(\bR\x06isLive\x12\x10\n" +
	"\x03lat\x18\a \x01(\x01R\x03lat\x12,\n" +
	"\x11paymentAmount1000\x18\b \x01(\x05R\x11paymentAmount1000\x12.\n" +
	"\x12paymentNoteMsgBody\x18\t \x01(\tR\x12paymentNoteMsgBody\x12 \n" +
	"\vmatchedText\x18\v \x01(\tR\vmatchedText\x12\x14\n" +
	"\x05title\x18\f \x01(\tR\x05title\x12 \n" +
	"\vdescription\x18\r \x01(\tR\vdescription\x12,\n" +
	"\x11futureproofBuffer\x18\x0e \x01(\fR\x11futureproofBuffer\x12\x1c\n" +
	"\tclientUrl\x18\x0f \x01(\tR\tclientUrl\x12\x10\n" +
	"\x03loc\x18\x10 \x01(\tR\x03loc\x12\x1a\n" +
	"\bpollName\x18\x11 \x01(\tR\bpollName\x12M\n" +
	"\vpollOptions\x18\x12 \x03(\v2+.WAWebProtobufsE2E.MsgOpaqueData.PollOptionR\vpollOptions\x12>\n" +
	"\x1apollSelectableOptionsCount\x18\x14 \x01(\rR\x1apollSelectableOptionsCount\x12$\n" +
	"\rmessageSecret\x18\x15 \x01(\fR\rmessageSecret\x12.\n" +
	"\x12originalSelfAuthor\x183 \x01(\tR\x12originalSelfAuthor\x12,\n" +
	"\x11senderTimestampMs\x18\x16 \x01(\x03R\x11senderTimestampMs\x120\n" +
	"\x13pollUpdateParentKey\x18\x17 \x01(\tR\x13pollUpdateParentKey\x12A\n" +
	"\vencPollVote\x18\x18 \x01(\v2\x1f.WAWebProtobufsE2E.PollEncValueR\vencPollVote\x124\n" +
	"\x15isSentCagPollCreation\x18\x1c \x01(\bR\x15isSentCagPollCreation\x12Z\n" +
	"\x0fpollContentType\x18* \x01(\x0e20.WAWebProtobufsE2E.MsgOpaqueData.PollContentTypeR\x0fpollContentType\x12E\n" +
	"\bpollType\x18. \x01(\x0e2).WAWebProtobufsE2E.MsgOpaqueData.PollTypeR\bpollType\x12.\n" +
	"\x12correctOptionIndex\x18/ \x01(\x05R\x12correctOptionIndex\x12`\n" +
	"\x11pollVotesSnapshot\x18) \x01(\v22.WAWebProtobufsE2E.MsgOpaqueData.PollVotesSnapshotR\x11pollVotesSnapshot\x12@\n" +
	"\x1bencReactionTargetMessageKey\x18\x19 \x01(\tR\x1bencReactionTargetMessageKey\x124\n" +
	"\x15encReactionEncPayload\x18\x1a \x01(\fR\x15encReactionEncPayload\x12*\n" +
	"\x10encReactionEncIv\x18\x1b \x01(\fR\x10encReactionEncIv\x12*\n" +
	"\x10botMessageSecret\x18\x1d \x01(\fR\x10botMessageSecret\x12*\n" +
	"\x10targetMessageKey\x18\x1e \x01(\tR\x10targetMessageKey\x12\x1e\n" +
	"\n" +
	"encPayload\x18\x1f \x01(\fR\n" +
	"encPayload\x12\x14\n" +
	"\x05encIv\x18  \x01(\fR\x05encIv\x12\x1c\n" +
	"\teventName\x18! \x01(\tR\teventName\x12(\n" +
	"\x0fisEventCanceled\x18\" \x01(\bR\x0fisEventCanceled\x12*\n" +
	"\x10eventDescription\x18# \x01(\tR\x10eventDescription\x12$\n" +
	"\reventJoinLink\x18$ \x01(\tR\reventJoinLink\x12&\n" +
	"\x0eeventStartTime\x18% \x01(\x03R\x0eeventStartTime\x12T\n" +
	"\reventLocation\x18& \x01(\v2..WAWebProtobufsE2E.MsgOpaqueData.EventLocationR\reventLocation\x12\"\n" +
	"\feventEndTime\x18( \x01(\x03R\feventEndTime\x122\n" +
	"\x14eventIsScheduledCall\x18, \x01(\bR\x14eventIsScheduledCall\x128\n" +
	"\x17eventExtraGuestsAllowed\x18- \x01(\bR\x17eventExtraGuestsAllowed\x12.\n" +
	"\x12plainProtobufBytes\x18+ \x01(\fR\x12plainProtobufBytes\x128\n" +
	"\x17quarantineExtractedText\x180 \x01(\tR\x17quarantineExtractedText\x12 \n" +
	"\vpollEndTime\x181 \x01(\x03R\vpollEndTime\x12.\n" +
	"\x12pollHideVoterNames\x182 \x01(\bR\x12pollHideVoterNames\x1a\xcb\x01\n" +
	"\rEventLocation\x12(\n" +
	"\x0fdegreesLatitude\x18\x01 \x01(\x01R\x0fdegreesLatitude\x12*\n" +
	"\x10degreesLongitude\x18\x02 \x01(\x01R\x10degreesLongitude\x12\x12\n" +
	"\x04name\x18\x03 \x01(\tR\x04name\x12\x18\n" +
	...
	"\rjpegThumbnail\x18\x06 \x01(\fR\rjpegThumbnail\x1a4\n" +
	"\n" +
	"PollOption\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x12\n" +
	"\x04hash\x18\x02 \x01(\tR\x04hash\x1a\x81\x01\n" +
	"\x10PollVoteSnapshot\x12C\n" +
	"\x06option\x18\x01 \x01(\v2+.WAWebProtobufsE2E.MsgOpaqueData.PollOptionR\x06option\x12(\n" +
	"\x0foptionVoteCount\x18\x02 \x01(\x05R\x0foptionVoteCount\x1ad\n" +
	"\x11PollVotesSnapshot\x12O\n" +
	"\tpollVotes\x18\x01 \x03(\v21.WAWebProtobufsE2E.MsgOpaqueData.PollVoteSnapshotR\tpollVotes\"3\n" +
	...
	"\x04QUIZ\x10\x01\"\x94\x01\n" +
	"\x10MsgRowOpaqueData\x12@\n" +
	"\n" +
	"currentMsg\x18\x01 \x01(\v2 .WAWebProtobufsE2E.MsgOpaqueDataR\n" +
	"currentMsg\x12>\n" +
	"\tquotedMsg\x18\x02 \x01(\v2 .WAWebProtobufsE2E.MsgOpaqueDataR\tquotedMsg\"@\n" +
	"\n" +
	"ActionLink\x12\x10\n" +
	"\x03URL\x18\x01 \x01(\tR\x03URL\x12 \n" +
...
var file_waE2E_WAWebProtobufsE2E_proto_msgTypes = make([]protoimpl.MessageInfo, 204)
var file_waE2E_WAWebProtobufsE2E_proto_goTypes = []any{
	...
	(MsgOpaqueData_PollContentType)(0),                                    // 69: WAWebProtobufsE2E.MsgOpaqueData.PollContentType
	(MsgOpaqueData_PollType)(0),                                           // 70: WAWebProtobufsE2E.MsgOpaqueData.PollType
	...
	(*EncCommentMessage)(nil),                                             // 121: WAWebProtobufsE2E.EncCommentMessage
	(*EncReactionMessage)(nil),                                            // 122: WAWebProtobufsE2E.EncReactionMessage
	(*KeepInChatMessage)(nil),                                             // 123: WAWebProtobufsE2E.KeepInChatMessage
	(*QuestionResponseMessage)(nil),                                       // 124: WAWebProtobufsE2E.QuestionResponseMessage
	(*StatusQuestionAnswerMessage)(nil),                                   // 125: WAWebProtobufsE2E.StatusQuestionAnswerMessage
	(*PollResultSnapshotMessage)(nil),                                     // 126: WAWebProtobufsE2E.PollResultSnapshotMessage
	(*PollVoteMessage)(nil),                                               // 127: WAWebProtobufsE2E.PollVoteMessage
	(*PollEncValue)(nil),                                                  // 128: WAWebProtobufsE2E.PollEncValue
	(*PollUpdateMessageMetadata)(nil),                                     // 129: WAWebProtobufsE2E.PollUpdateMessageMetadata
	(*PollUpdateMessage)(nil),                                             // 130: WAWebProtobufsE2E.PollUpdateMessage
	(*PollCreationMessage)(nil),                                           // 131: WAWebProtobufsE2E.PollCreationMessage
	(*StickerSyncRMRMessage)(nil),                                         // 132: WAWebProtobufsE2E.StickerSyncRMRMessage
	(*ReactionMessage)(nil),                                               // 133: WAWebProtobufsE2E.ReactionMessage
	(*FutureProofMessage)(nil),                                            // 134: WAWebProtobufsE2E.FutureProofMessage
	(*DeviceSentMessage)(nil),                                             // 135: WAWebProtobufsE2E.DeviceSentMessage
	(*RequestPhoneNumberMessage)(nil),                                     // 136: WAWebProtobufsE2E.RequestPhoneNumberMessage
	(*NewsletterFollowerInviteMessage)(nil),                               // 137: WAWebProtobufsE2E.NewsletterFollowerInviteMessage
	...
	(*FullHistorySyncOnDemandConfig)(nil),                                 // 150: WAWebProtobufsE2E.FullHistorySyncOnDemandConfig
	...
	(*HistorySyncNotification)(nil),                                       // 159: WAWebProtobufsE2E.HistorySyncNotification
	(*HistorySyncMessageAccessStatus)(nil),                                // 160: WAWebProtobufsE2E.HistorySyncMessageAccessStatus
	(*Chat)(nil),                                                          // 161: WAWebProtobufsE2E.Chat
	(*Call)(nil),                                                          // 162: WAWebProtobufsE2E.Call
	(*AudioMessage)(nil),                                                  // 163: WAWebProtobufsE2E.AudioMessage
	(*DocumentMessage)(nil),                                               // 164: WAWebProtobufsE2E.DocumentMessage
	(*URLMetadata)(nil),                                                   // 165: WAWebProtobufsE2E.URLMetadata
	(*PaymentExtendedMetadata)(nil),                                       // 166: WAWebProtobufsE2E.PaymentExtendedMetadata
	(*MMSThumbnailMetadata)(nil),                                          // 167: WAWebProtobufsE2E.MMSThumbnailMetadata
	(*LocationMessage)(nil),                                               // 168: WAWebProtobufsE2E.LocationMessage
	(*ContactMessage)(nil),                                                // 169: WAWebProtobufsE2E.ContactMessage
	(*SenderKeyDistributionMessage)(nil),                                  // 170: WAWebProtobufsE2E.SenderKeyDistributionMessage
	(*VideoEndCard)(nil),                                                  // 171: WAWebProtobufsE2E.VideoEndCard
	(*MediaDomainInfo)(nil),                                               // 172: WAWebProtobufsE2E.MediaDomainInfo
	(*DeviceListMetadata)(nil),                                            // 173: WAWebProtobufsE2E.DeviceListMetadata
	(*EmbeddedMessage)(nil),                                               // 174: WAWebProtobufsE2E.EmbeddedMessage
	(*EmbeddedMusic)(nil),                                                 // 175: WAWebProtobufsE2E.EmbeddedMusic
	(*EmbeddedContent)(nil),                                               // 176: WAWebProtobufsE2E.EmbeddedContent
	(*TapLinkAction)(nil),                                                 // 177: WAWebProtobufsE2E.TapLinkAction
	(*Point)(nil),                                                         // 178: WAWebProtobufsE2E.Point
	(*Location)(nil),                                                      // 179: WAWebProtobufsE2E.Location
	(*TemplateButton)(nil),                                                // 180: WAWebProtobufsE2E.TemplateButton
	...
	(*ActionLink)(nil),                                                    // 184: WAWebProtobufsE2E.ActionLink
	(*GroupMention)(nil),                                                  // 185: WAWebProtobufsE2E.GroupMention
	(*MessageSecretMessage)(nil),                                          // 186: WAWebProtobufsE2E.MessageSecretMessage
	(*MediaNotifyMessage)(nil),                                            // 187: WAWebProtobufsE2E.MediaNotifyMessage
	(*LIDMigrationMappingSyncMessage)(nil),                                // 188: WAWebProtobufsE2E.LIDMigrationMappingSyncMessage
	(*UrlTrackingMap)(nil),                                                // 189: WAWebProtobufsE2E.UrlTrackingMap
	(*MemberLabel)(nil),                                                   // 190: WAWebProtobufsE2E.MemberLabel
	(*AIRichResponseMessage)(nil),                                         // 191: WAWebProtobufsE2E.AIRichResponseMessage
	(*AIQueryFanout)(nil),                                                 // 192: WAWebProtobufsE2E.AIQueryFanout
	(*StickerPackMessage_Sticker)(nil),                                    // 193: WAWebProtobufsE2E.StickerPackMessage.Sticker
	(*CallLogMessage_CallParticipant)(nil),                                // 194: WAWebProtobufsE2E.CallLogMessage.CallParticipant
	(*ButtonsMessage_Button)(nil),                                         // 195: WAWebProtobufsE2E.ButtonsMessage.Button
	(*ButtonsMessage_Button_NativeFlowInfo)(nil),                          // 196: WAWebProtobufsE2E.ButtonsMessage.Button.NativeFlowInfo
	(*ButtonsMessage_Button_ButtonText)(nil),                              // 197: WAWebProtobufsE2E.ButtonsMessage.Button.ButtonText
	(*InteractiveResponseMessage_Body)(nil),                               // 198: WAWebProtobufsE2E.InteractiveResponseMessage.Body
	(*InteractiveResponseMessage_NativeFlowResponseMessage)(nil),          // 199: WAWebProtobufsE2E.InteractiveResponseMessage.NativeFlowResponseMessage
	(*InteractiveMessage_CarouselMessage)(nil),                            // 200: WAWebProtobufsE2E.InteractiveMessage.CarouselMessage
	(*InteractiveMessage_ShopMessage)(nil),                                // 201: WAWebProtobufsE2E.InteractiveMessage.ShopMessage
	(*InteractiveMessage_NativeFlowMessage)(nil),                          // 202: WAWebProtobufsE2E.InteractiveMessage.NativeFlowMessage
	(*InteractiveMessage_CollectionMessage)(nil),                          // 203: WAWebProtobufsE2E.InteractiveMessage.CollectionMessage
	...
	(*InteractiveMessage_BloksWidget)(nil),                                // 207: WAWebProtobufsE2E.InteractiveMessage.BloksWidget
	(*InteractiveMessage_NativeFlowMessage_NativeFlowButton)(nil),         // 208: WAWebProtobufsE2E.InteractiveMessage.NativeFlowMessage.NativeFlowButton
	(*ListResponseMessage_SingleSelectReply)(nil),                         // 209: WAWebProtobufsE2E.ListResponseMessage.SingleSelectReply
	(*ListMessage_ProductListInfo)(nil),                                   // 210: WAWebProtobufsE2E.ListMessage.ProductListInfo
	(*ListMessage_ProductListHeaderImage)(nil),                            // 211: WAWebProtobufsE2E.ListMessage.ProductListHeaderImage
	(*ListMessage_ProductSection)(nil),                                    // 212: WAWebProtobufsE2E.ListMessage.ProductSection
	(*ListMessage_Product)(nil),                                           // 213: WAWebProtobufsE2E.ListMessage.Product
	(*ListMessage_Section)(nil),                                           // 214: WAWebProtobufsE2E.ListMessage.Section
	(*ListMessage_Row)(nil),                                               // 215: WAWebProtobufsE2E.ListMessage.Row
	(*HighlyStructuredMessage_HSMLocalizableParameter)(nil),               // 216: WAWebProtobufsE2E.HighlyStructuredMessage.HSMLocalizableParameter
	(*HighlyStructuredMessage_HSMLocalizableParameter_HSMDateTime)(nil),   // 217: WAWebProtobufsE2E.HighlyStructuredMessage.HSMLocalizableParameter.HSMDateTime
	(*HighlyStructuredMessage_HSMLocalizableParameter_HSMCurrency)(nil),   // 218: WAWebProtobufsE2E.HighlyStructuredMessage.HSMLocalizableParameter.HSMCurrency
	(*HighlyStructuredMessage_HSMLocalizableParameter_HSMDateTime_HSMDateTimeComponent)(nil),                                    // 219: WAWebProtobufsE2E.HighlyStructuredMessage.HSMLocalizableParameter.HSMDateTime.HSMDateTimeComponent
	(*HighlyStructuredMessage_HSMLocalizableParameter_HSMDateTime_HSMDateTimeUnixEpoch)(nil),                                    // 220: WAWebProtobufsE2E.HighlyStructuredMessage.HSMLocalizableParameter.HSMDateTime.HSMDateTimeUnixEpoch
	(*PeerDataOperationRequestResponseMessage_PeerDataOperationResult)(nil),                                                     // 221: WAWebProtobufsE2E.PeerDataOperationRequestResponseMessage.PeerDataOperationResult
	...
	(*PeerDataOperationRequestResponseMessage_PeerDataOperationResult_FlowResponsesCsvBundle)(nil),                              // 226: WAWebProtobufsE2E.PeerDataOperationRequestResponseMessage.PeerDataOperationResult.FlowResponsesCsvBundle
	(*PeerDataOperationRequestResponseMessage_PeerDataOperationResult_WaffleNonceFetchResponse)(nil),                            // 227: WAWebProtobufsE2E.PeerDataOperationRequestResponseMessage.PeerDataOperationResult.WaffleNonceFetchResponse
	(*PeerDataOperationRequestResponseMessage_PeerDataOperationResult_FullHistorySyncOnDemandRequestResponse)(nil),              // 228: WAWebProtobufsE2E.PeerDataOperationRequestResponseMessage.PeerDataOperationResult.FullHistorySyncOnDemandRequestResponse
	(*PeerDataOperationRequestResponseMessage_PeerDataOperationResult_PlaceholderMessageResendResponse)(nil),                    // 229: WAWebProtobufsE2E.PeerDataOperationRequestResponseMessage.PeerDataOperationResult.PlaceholderMessageResendResponse
	(*PeerDataOperationRequestResponseMessage_PeerDataOperationResult_LinkPreviewResponse)(nil),                                 // 230: WAWebProtobufsE2E.PeerDataOperationRequestResponseMessage.PeerDataOperationResult.LinkPreviewResponse
	(*PeerDataOperationRequestResponseMessage_PeerDataOperationResult_LinkPreviewResponse_PaymentLinkPreviewMetadata)(nil),      // 231: WAWebProtobufsE2E.PeerDataOperationRequestResponseMessage.PeerDataOperationResult.LinkPreviewResponse.PaymentLinkPreviewMetadata
	(*PeerDataOperationRequestResponseMessage_PeerDataOperationResult_LinkPreviewResponse_LinkPreviewHighQualityThumbnail)(nil), // 232: WAWebProtobufsE2E.PeerDataOperationRequestResponseMessage.PeerDataOperationResult.LinkPreviewResponse.LinkPreviewHighQualityThumbnail
	(*PeerDataOperationRequestMessage_GalaxyFlowAction)(nil),                                                                    // 233: WAWebProtobufsE2E.PeerDataOperationRequestMessage.GalaxyFlowAction
	...
	(*PeerDataOperationRequestMessage_CompanionCanonicalUserNonceFetchRequest)(nil),                                             // 241: WAWebProtobufsE2E.PeerDataOperationRequestMessage.CompanionCanonicalUserNonceFetchRequest
	(*CloudAPIThreadControlNotification_CloudAPIThreadControlNotificationContent)(nil),                                          // 242: WAWebProtobufsE2E.CloudAPIThreadControlNotification.CloudAPIThreadControlNotificationContent
	(*PaymentLinkMetadata_PaymentLinkHeader)(nil),                                                                               // 243: WAWebProtobufsE2E.PaymentLinkMetadata.PaymentLinkHeader
	(*PaymentLinkMetadata_PaymentLinkProvider)(nil),                                                                             // 244: WAWebProtobufsE2E.PaymentLinkMetadata.PaymentLinkProvider
	(*PaymentLinkMetadata_PaymentLinkButton)(nil),                                                                               // 245: WAWebProtobufsE2E.PaymentLinkMetadata.PaymentLinkButton
	(*ContextInfo_StatusAudienceMetadata)(nil),                                                                                  // 246: WAWebProtobufsE2E.ContextInfo.StatusAudienceMetadata
	(*ContextInfo_DataSharingContext)(nil),                                                                                      // 247: WAWebProtobufsE2E.ContextInfo.DataSharingContext
	(*ContextInfo_ForwardedNewsletterMessageInfo)(nil),                                                                          // 248: WAWebProtobufsE2E.ContextInfo.ForwardedNewsletterMessageInfo
	(*ContextInfo_ExternalAdReplyInfo)(nil),                                                                                     // 249: WAWebProtobufsE2E.ContextInfo.ExternalAdReplyInfo
	(*ContextInfo_AdReplyInfo)(nil),                                                                                             // 250: WAWebProtobufsE2E.ContextInfo.AdReplyInfo
	(*ContextInfo_PartiallySelectedContent)(nil),                                                                                // 251: WAWebProtobufsE2E.ContextInfo.PartiallySelectedContent
	(*ContextInfo_FeatureEligibilities)(nil),                                                                                    // 252: WAWebProtobufsE2E.ContextInfo.FeatureEligibilities
	(*ContextInfo_QuestionReplyQuotedMessage)(nil),                                                                              // 253: WAWebProtobufsE2E.ContextInfo.QuestionReplyQuotedMessage
	(*ContextInfo_UTMInfo)(nil),                             // 254: WAWebProtobufsE2E.ContextInfo.UTMInfo
	(*ContextInfo_BusinessMessageForwardInfo)(nil),          // 255: WAWebProtobufsE2E.ContextInfo.BusinessMessageForwardInfo
	(*ContextInfo_DataSharingContext_Parameters)(nil),       // 256: WAWebProtobufsE2E.ContextInfo.DataSharingContext.Parameters
	(*HydratedTemplateButton_HydratedURLButton)(nil),        // 257: WAWebProtobufsE2E.HydratedTemplateButton.HydratedURLButton
	(*HydratedTemplateButton_HydratedCallButton)(nil),       // 258: WAWebProtobufsE2E.HydratedTemplateButton.HydratedCallButton
	(*HydratedTemplateButton_HydratedQuickReplyButton)(nil), // 259: WAWebProtobufsE2E.HydratedTemplateButton.HydratedQuickReplyButton
	(*PaymentBackground_MediaData)(nil),                     // 260: WAWebProtobufsE2E.PaymentBackground.MediaData
	(*PollResultSnapshotMessage_PollVote)(nil),              // 261: WAWebProtobufsE2E.PollResultSnapshotMessage.PollVote
	(*PollCreationMessage_Option)(nil),                      // 262: WAWebProtobufsE2E.PollCreationMessage.Option
	...
	(*TemplateButton_CallButton)(nil),                       // 267: WAWebProtobufsE2E.TemplateButton.CallButton
	(*TemplateButton_URLButton)(nil),                        // 268: WAWebProtobufsE2E.TemplateButton.URLButton
	(*TemplateButton_QuickReplyButton)(nil),                 // 269: WAWebProtobufsE2E.TemplateButton.QuickReplyButton
	(*MsgOpaqueData_EventLocation)(nil),                     // 270: WAWebProtobufsE2E.MsgOpaqueData.EventLocation
	(*MsgOpaqueData_PollOption)(nil),                        // 271: WAWebProtobufsE2E.MsgOpaqueData.PollOption
	(*MsgOpaqueData_PollVoteSnapshot)(nil),                  // 272: WAWebProtobufsE2E.MsgOpaqueData.PollVoteSnapshot
	(*MsgOpaqueData_PollVotesSnapshot)(nil),                 // 273: WAWebProtobufsE2E.MsgOpaqueData.PollVotesSnapshot
	(*UrlTrackingMap_UrlTrackingMapElement)(nil),            // 274: WAWebProtobufsE2E.UrlTrackingMap.UrlTrackingMapElement
	(*waCommon.MessageKey)(nil),                             // 275: WACommon.MessageKey
	(*waAICommon.BotFeedbackMessage)(nil),                   // 276: WAWebProtobufsAICommon.BotFeedbackMessage
	(*waCommon.LimitSharing)(nil),                           // 277: WACommon.LimitSharing
	(*waAICommon.AIMediaCollectionMessage)(nil),             // 278: WAWebProtobufsAICommon.AIMediaCollectionMessage
	(*waAICommon.ForwardedAIBotMessageInfo)(nil),            // 279: WAWebProtobufsAICommon.ForwardedAIBotMessageInfo
	(*waStatusAttributions.StatusAttribution)(nil),          // 280: WAStatusAttributions.StatusAttribution
	(*waAICommon.BotMessageSharingInfo)(nil),                // 281: WAWebProtobufsAICommon.BotMessageSharingInfo
	(*waAICommon.BotMetadata)(nil),                          // 282: WAWebProtobufsAICommon.BotMetadata
	(waAdv.ADVEncryptionType)(0),                            // 283: WAAdv.ADVEncryptionType
	(waAICommon.AIRichResponseMessageType)(0),               // 284: WAWebProtobufsAICommon.AIRichResponseMessageType
	(*waAICommon.AIRichResponseSubMessage)(nil),             // 285: WAWebProtobufsAICommon.AIRichResponseSubMessage
	(*waAICommon.AIRichResponseUnifiedResponse)(nil),        // 286: WAWebProtobufsAICommon.AIRichResponseUnifiedResponse
	(waMmsRetry.MediaRetryNotification_ResultType)(0),       // 287: WAMmsRetry.MediaRetryNotification.ResultType
	(*waCompanionReg.DeviceProps_HistorySyncConfig)(nil),    // 288: WACompanionReg.DeviceProps.HistorySyncConfig
}
var file_waE2E_WAWebProtobufsE2E_proto_depIdxs = []int32{
	193, // 0: WAWebProtobufsE2E.StickerPackMessage.stickers:type_name -> WAWebProtobufsE2E.StickerPackMessage.Sticker
	...
	194, // 7: WAWebProtobufsE2E.CallLogMessage.participants:type_name -> WAWebProtobufsE2E.CallLogMessage.CallParticipant
	275, // 8: WAWebProtobufsE2E.ScheduledCallEditMessage.key:type_name -> WACommon.MessageKey
	...
	275, // 12: WAWebProtobufsE2E.PinInChatMessage.key:type_name -> WACommon.MessageKey
	15,  // 13: WAWebProtobufsE2E.PinInChatMessage.type:type_name -> WAWebProtobufsE2E.PinInChatMessage.Type
	275, // 14: WAWebProtobufsE2E.StatusStickerInteractionMessage.key:type_name -> WACommon.MessageKey
	...
	164, // 18: WAWebProtobufsE2E.ButtonsMessage.documentMessage:type_name -> WAWebProtobufsE2E.DocumentMessage
	...
	168, // 21: WAWebProtobufsE2E.ButtonsMessage.locationMessage:type_name -> WAWebProtobufsE2E.LocationMessage
	104, // 22: WAWebProtobufsE2E.ButtonsMessage.contextInfo:type_name -> WAWebProtobufsE2E.ContextInfo
	195, // 23: WAWebProtobufsE2E.ButtonsMessage.buttons:type_name -> WAWebProtobufsE2E.ButtonsMessage.Button
	18,  // 24: WAWebProtobufsE2E.ButtonsMessage.headerType:type_name -> WAWebProtobufsE2E.ButtonsMessage.HeaderType
	275, // 25: WAWebProtobufsE2E.SecretEncryptedMessage.targetMessageKey:type_name -> WACommon.MessageKey
	...
	199, // 29: WAWebProtobufsE2E.InteractiveResponseMessage.nativeFlowResponseMessage:type_name -> WAWebProtobufsE2E.InteractiveResponseMessage.NativeFlowResponseMessage
	198, // 30: WAWebProtobufsE2E.InteractiveResponseMessage.body:type_name -> WAWebProtobufsE2E.InteractiveResponseMessage.Body
	104, // 31: WAWebProtobufsE2E.InteractiveResponseMessage.contextInfo:type_name -> WAWebProtobufsE2E.ContextInfo
	201, // 32: WAWebProtobufsE2E.InteractiveMessage.shopStorefrontMessage:type_name -> WAWebProtobufsE2E.InteractiveMessage.ShopMessage
	203, // 33: WAWebProtobufsE2E.InteractiveMessage.collectionMessage:type_name -> WAWebProtobufsE2E.InteractiveMessage.CollectionMessage
	202, // 34: WAWebProtobufsE2E.InteractiveMessage.nativeFlowMessage:type_name -> WAWebProtobufsE2E.InteractiveMessage.NativeFlowMessage
	200, // 35: WAWebProtobufsE2E.InteractiveMessage.carouselMessage:type_name -> WAWebProtobufsE2E.InteractiveMessage.CarouselMessage
	...
	207, // 39: WAWebProtobufsE2E.InteractiveMessage.bloksWidget:type_name -> WAWebProtobufsE2E.InteractiveMessage.BloksWidget
	104, // 40: WAWebProtobufsE2E.InteractiveMessage.contextInfo:type_name -> WAWebProtobufsE2E.ContextInfo
	189, // 41: WAWebProtobufsE2E.InteractiveMessage.urlTrackingMap:type_name -> WAWebProtobufsE2E.UrlTrackingMap
	25,  // 42: WAWebProtobufsE2E.ListResponseMessage.listType:type_name -> WAWebProtobufsE2E.ListResponseMessage.ListType
	209, // 43: WAWebProtobufsE2E.ListResponseMessage.singleSelectReply:type_name -> WAWebProtobufsE2E.ListResponseMessage.SingleSelectReply
	...
	214, // 46: WAWebProtobufsE2E.ListMessage.sections:type_name -> WAWebProtobufsE2E.ListMessage.Section
	210, // 47: WAWebProtobufsE2E.ListMessage.productListInfo:type_name -> WAWebProtobufsE2E.ListMessage.ProductListInfo
	...
	275, // 52: WAWebProtobufsE2E.OrderMessage.orderRequestMessageID:type_name -> WACommon.MessageKey
	29,  // 53: WAWebProtobufsE2E.StatusQuotedMessage.type:type_name -> WAWebProtobufsE2E.StatusQuotedMessage.StatusQuotedMessageType
	275, // 54: WAWebProtobufsE2E.StatusQuotedMessage.originalStatusID:type_name -> WACommon.MessageKey
	30,  // 55: WAWebProtobufsE2E.PaymentInviteMessage.serviceType:type_name -> WAWebProtobufsE2E.PaymentInviteMessage.ServiceType
	216, // 56: WAWebProtobufsE2E.HighlyStructuredMessage.localizableParams:type_name -> WAWebProtobufsE2E.HighlyStructuredMessage.HSMLocalizableParameter
	...
	221, // 59: WAWebProtobufsE2E.PeerDataOperationRequestResponseMessage.peerDataOperationResult:type_name -> WAWebProtobufsE2E.PeerDataOperationRequestResponseMessage.PeerDataOperationResult
	...
	233, // 68: WAWebProtobufsE2E.PeerDataOperationRequestMessage.galaxyFlowAction:type_name -> WAWebProtobufsE2E.PeerDataOperationRequestMessage.GalaxyFlowAction
	241, // 69: WAWebProtobufsE2E.PeerDataOperationRequestMessage.companionCanonicalUserNonceFetchRequest:type_name -> WAWebProtobufsE2E.PeerDataOperationRequestMessage.CompanionCanonicalUserNonceFetchRequest
	...
	275, // 71: WAWebProtobufsE2E.ProtocolMessage.key:type_name -> WACommon.MessageKey
	37,  // 72: WAWebProtobufsE2E.ProtocolMessage.type:type_name -> WAWebProtobufsE2E.ProtocolMessage.Type
	159, // 73: WAWebProtobufsE2E.ProtocolMessage.historySyncNotification:type_name -> WAWebProtobufsE2E.HistorySyncNotification
	154, // 74: WAWebProtobufsE2E.ProtocolMessage.appStateSyncKeyShare:type_name -> WAWebProtobufsE2E.AppStateSyncKeyShare
	153, // 75: WAWebProtobufsE2E.ProtocolMessage.appStateSyncKeyRequest:type_name -> WAWebProtobufsE2E.AppStateSyncKeyRequest
	149, // 76: WAWebProtobufsE2E.ProtocolMessage.initialSecurityNotificationSettingSync:type_name -> WAWebProtobufsE2E.InitialSecurityNotificationSettingSync
	152, // 77: WAWebProtobufsE2E.ProtocolMessage.appStateFatalExceptionNotification:type_name -> WAWebProtobufsE2E.AppStateFatalExceptionNotification
	111, // 78: WAWebProtobufsE2E.ProtocolMessage.disappearingMode:type_name -> WAWebProtobufsE2E.DisappearingMode
	113, // 79: WAWebProtobufsE2E.ProtocolMessage.editedMessage:type_name -> WAWebProtobufsE2E.Message
	93,  // 80: WAWebProtobufsE2E.ProtocolMessage.peerDataOperationRequestMessage:type_name -> WAWebProtobufsE2E.PeerDataOperationRequestMessage
	92,  // 81: WAWebProtobufsE2E.ProtocolMessage.peerDataOperationRequestResponseMessage:type_name -> WAWebProtobufsE2E.PeerDataOperationRequestResponseMessage
	276, // 82: WAWebProtobufsE2E.ProtocolMessage.botFeedbackMessage:type_name -> WAWebProtobufsAICommon.BotFeedbackMessage
	94,  // 83: WAWebProtobufsE2E.ProtocolMessage.requestWelcomeMessageMetadata:type_name -> WAWebProtobufsE2E.RequestWelcomeMessageMetadata
	187, // 84: WAWebProtobufsE2E.ProtocolMessage.mediaNotifyMessage:type_name -> WAWebProtobufsE2E.MediaNotifyMessage
	96,  // 85: WAWebProtobufsE2E.ProtocolMessage.cloudApiThreadControlNotification:type_name -> WAWebProtobufsE2E.CloudAPIThreadControlNotification
	188, // 86: WAWebProtobufsE2E.ProtocolMessage.lidMigrationMappingSyncMessage:type_name -> WAWebProtobufsE2E.LIDMigrationMappingSyncMessage
	277, // 87: WAWebProtobufsE2E.ProtocolMessage.limitSharing:type_name -> WACommon.LimitSharing
	192, // 88: WAWebProtobufsE2E.ProtocolMessage.aiQueryFanout:type_name -> WAWebProtobufsE2E.AIQueryFanout
	190, // 89: WAWebProtobufsE2E.ProtocolMessage.memberLabel:type_name -> WAWebProtobufsE2E.MemberLabel
	278, // 90: WAWebProtobufsE2E.ProtocolMessage.aiMediaCollectionMessage:type_name -> WAWebProtobufsAICommon.AIMediaCollectionMessage
	...
	242, // 92: WAWebProtobufsE2E.CloudAPIThreadControlNotification.notificationContent:type_name -> WAWebProtobufsE2E.CloudAPIThreadControlNotification.CloudAPIThreadControlNotificationContent
	108, // 93: WAWebProtobufsE2E.VideoMessage.interactiveAnnotations:type_name -> WAWebProtobufsE2E.InteractiveAnnotation
	104, // 94: WAWebProtobufsE2E.VideoMessage.contextInfo:type_name -> WAWebProtobufsE2E.ContextInfo
	40,  // 95: WAWebProtobufsE2E.VideoMessage.gifAttribution:type_name -> WAWebProtobufsE2E.VideoMessage.Attribution
	108, // 96: WAWebProtobufsE2E.VideoMessage.annotations:type_name -> WAWebProtobufsE2E.InteractiveAnnotation
	112, // 97: WAWebProtobufsE2E.VideoMessage.processedVideos:type_name -> WAWebProtobufsE2E.ProcessedVideo
	...
	104, // 101: WAWebProtobufsE2E.ExtendedTextMessage.contextInfo:type_name -> WAWebProtobufsE2E.ContextInfo
	...
	167, // 104: WAWebProtobufsE2E.ExtendedTextMessage.faviconMMSMetadata:type_name -> WAWebProtobufsE2E.MMSThumbnailMetadata
	99,  // 105: WAWebProtobufsE2E.ExtendedTextMessage.linkPreviewMetadata:type_name -> WAWebProtobufsE2E.LinkPreviewMetadata
	100, // 106: WAWebProtobufsE2E.ExtendedTextMessage.paymentLinkMetadata:type_name -> WAWebProtobufsE2E.PaymentLinkMetadata
	171, // 107: WAWebProtobufsE2E.ExtendedTextMessage.endCardTiles:type_name -> WAWebProtobufsE2E.VideoEndCard
	175, // 108: WAWebProtobufsE2E.ExtendedTextMessage.musicMetadata:type_name -> WAWebProtobufsE2E.EmbeddedMusic
	166, // 109: WAWebProtobufsE2E.ExtendedTextMessage.paymentExtendedMetadata:type_name -> WAWebProtobufsE2E.PaymentExtendedMetadata
	100, // 110: WAWebProtobufsE2E.LinkPreviewMetadata.paymentLinkMetadata:type_name -> WAWebProtobufsE2E.PaymentLinkMetadata
	165, // 111: WAWebProtobufsE2E.LinkPreviewMetadata.urlMetadata:type_name -> WAWebProtobufsE2E.URLMetadata
	...
	175, // 113: WAWebProtobufsE2E.LinkPreviewMetadata.musicMetadata:type_name -> WAWebProtobufsE2E.EmbeddedMusic
	245, // 114: WAWebProtobufsE2E.PaymentLinkMetadata.button:type_name -> WAWebProtobufsE2E.PaymentLinkMetadata.PaymentLinkButton
	243, // 115: WAWebProtobufsE2E.PaymentLinkMetadata.header:type_name -> WAWebProtobufsE2E.PaymentLinkMetadata.PaymentLinkHeader
	244, // 116: WAWebProtobufsE2E.PaymentLinkMetadata.provider:type_name -> WAWebProtobufsE2E.PaymentLinkMetadata.PaymentLinkProvider
	275, // 117: WAWebProtobufsE2E.StatusNotificationMessage.responseMessageKey:type_name -> WACommon.MessageKey
	275, // 118: WAWebProtobufsE2E.StatusNotificationMessage.originalMessageKey:type_name -> WACommon.MessageKey
	...
	108, // 121: WAWebProtobufsE2E.ImageMessage.interactiveAnnotations:type_name -> WAWebProtobufsE2E.InteractiveAnnotation
	104, // 122: WAWebProtobufsE2E.ImageMessage.contextInfo:type_name -> WAWebProtobufsE2E.ContextInfo
	108, // 123: WAWebProtobufsE2E.ImageMessage.annotations:type_name -> WAWebProtobufsE2E.InteractiveAnnotation
	48,  // 124: WAWebProtobufsE2E.ImageMessage.imageSourceType:type_name -> WAWebProtobufsE2E.ImageMessage.ImageSourceType
	113, // 125: WAWebProtobufsE2E.ContextInfo.quotedMessage:type_name -> WAWebProtobufsE2E.Message
	250, // 126: WAWebProtobufsE2E.ContextInfo.quotedAd:type_name -> WAWebProtobufsE2E.ContextInfo.AdReplyInfo
	275, // 127: WAWebProtobufsE2E.ContextInfo.placeholderKey:type_name -> WACommon.MessageKey
	249, // 128: WAWebProtobufsE2E.ContextInfo.externalAdReply:type_name -> WAWebProtobufsE2E.ContextInfo.ExternalAdReplyInfo
	111, // 129: WAWebProtobufsE2E.ContextInfo.disappearingMode:type_name -> WAWebProtobufsE2E.DisappearingMode
	184, // 130: WAWebProtobufsE2E.ContextInfo.actionLink:type_name -> WAWebProtobufsE2E.ActionLink
	185, // 131: WAWebProtobufsE2E.ContextInfo.groupMentions:type_name -> WAWebProtobufsE2E.GroupMention
	254, // 132: WAWebProtobufsE2E.ContextInfo.utm:type_name -> WAWebProtobufsE2E.ContextInfo.UTMInfo
	248, // 133: WAWebProtobufsE2E.ContextInfo.forwardedNewsletterMessageInfo:type_name -> WAWebProtobufsE2E.ContextInfo.ForwardedNewsletterMessageInfo
	255, // 134: WAWebProtobufsE2E.ContextInfo.businessMessageForwardInfo:type_name -> WAWebProtobufsE2E.ContextInfo.BusinessMessageForwardInfo
	247, // 135: WAWebProtobufsE2E.ContextInfo.dataSharingContext:type_name -> WAWebProtobufsE2E.ContextInfo.DataSharingContext
	252, // 136: WAWebProtobufsE2E.ContextInfo.featureEligibilities:type_name -> WAWebProtobufsE2E.ContextInfo.FeatureEligibilities
	279, // 137: WAWebProtobufsE2E.ContextInfo.forwardedAiBotMessageInfo:type_name -> WAWebProtobufsAICommon.ForwardedAIBotMessageInfo
	53,  // 138: WAWebProtobufsE2E.ContextInfo.statusAttributionType:type_name -> WAWebProtobufsE2E.ContextInfo.StatusAttributionType
	189, // 139: WAWebProtobufsE2E.ContextInfo.urlTrackingMap:type_name -> WAWebProtobufsE2E.UrlTrackingMap
	52,  // 140: WAWebProtobufsE2E.ContextInfo.pairedMediaType:type_name -> WAWebProtobufsE2E.ContextInfo.PairedMediaType
	190, // 141: WAWebProtobufsE2E.ContextInfo.memberLabel:type_name -> WAWebProtobufsE2E.MemberLabel
	51,  // 142: WAWebProtobufsE2E.ContextInfo.statusSourceType:type_name -> WAWebProtobufsE2E.ContextInfo.StatusSourceType
	280, // 143: WAWebProtobufsE2E.ContextInfo.statusAttributions:type_name -> WAStatusAttributions.StatusAttribution
	50,  // 144: WAWebProtobufsE2E.ContextInfo.forwardOrigin:type_name -> WAWebProtobufsE2E.ContextInfo.ForwardOrigin
	253, // 145: WAWebProtobufsE2E.ContextInfo.questionReplyQuotedMessage:type_name -> WAWebProtobufsE2E.ContextInfo.QuestionReplyQuotedMessage
	246, // 146: WAWebProtobufsE2E.ContextInfo.statusAudienceMetadata:type_name -> WAWebProtobufsE2E.ContextInfo.StatusAudienceMetadata
	49,  // 147: WAWebProtobufsE2E.ContextInfo.quotedType:type_name -> WAWebProtobufsE2E.ContextInfo.QuotedType
	281, // 148: WAWebProtobufsE2E.ContextInfo.botMessageSharingInfo:type_name -> WAWebProtobufsAICommon.BotMessageSharingInfo
	172, // 149: WAWebProtobufsE2E.ContextInfo.mediaDomainInfo:type_name -> WAWebProtobufsE2E.MediaDomainInfo
	251, // 150: WAWebProtobufsE2E.ContextInfo.partiallySelectedContent:type_name -> WAWebProtobufsE2E.ContextInfo.PartiallySelectedContent
	...
	275, // 152: WAWebProtobufsE2E.MessageAssociation.parentMessageKey:type_name -> WACommon.MessageKey
	61,  // 153: WAWebProtobufsE2E.ThreadID.threadType:type_name -> WAWebProtobufsE2E.ThreadID.ThreadType
	275, // 154: WAWebProtobufsE2E.ThreadID.threadKey:type_name -> WACommon.MessageKey
	173, // 155: WAWebProtobufsE2E.MessageContextInfo.deviceListMetadata:type_name -> WAWebProtobufsE2E.DeviceListMetadata
	282, // 156: WAWebProtobufsE2E.MessageContextInfo.botMetadata:type_name -> WAWebProtobufsAICommon.BotMetadata
	...
	105, // 158: WAWebProtobufsE2E.MessageContextInfo.messageAssociation:type_name -> WAWebProtobufsE2E.MessageAssociation
	277, // 159: WAWebProtobufsE2E.MessageContextInfo.limitSharing:type_name -> WACommon.LimitSharing
	277, // 160: WAWebProtobufsE2E.MessageContextInfo.limitSharingV2:type_name -> WACommon.LimitSharing
	106, // 161: WAWebProtobufsE2E.MessageContextInfo.threadID:type_name -> WAWebProtobufsE2E.ThreadID
	5,   // 162: WAWebProtobufsE2E.MessageContextInfo.weblinkRenderConfig:type_name -> WAWebProtobufsE2E.WebLinkRenderConfig
	179, // 163: WAWebProtobufsE2E.InteractiveAnnotation.location:type_name -> WAWebProtobufsE2E.Location
	248, // 164: WAWebProtobufsE2E.InteractiveAnnotation.newsletter:type_name -> WAWebProtobufsE2E.ContextInfo.ForwardedNewsletterMessageInfo
	177, // 165: WAWebProtobufsE2E.InteractiveAnnotation.tapAction:type_name -> WAWebProtobufsE2E.TapLinkAction
	178, // 166: WAWebProtobufsE2E.InteractiveAnnotation.polygonVertices:type_name -> WAWebProtobufsE2E.Point
	176, // 167: WAWebProtobufsE2E.InteractiveAnnotation.embeddedContent:type_name -> WAWebProtobufsE2E.EmbeddedContent
	...
	259, // 169: WAWebProtobufsE2E.HydratedTemplateButton.quickReplyButton:type_name -> WAWebProtobufsE2E.HydratedTemplateButton.HydratedQuickReplyButton
	257, // 170: WAWebProtobufsE2E.HydratedTemplateButton.urlButton:type_name -> WAWebProtobufsE2E.HydratedTemplateButton.HydratedURLButton
	258, // 171: WAWebProtobufsE2E.HydratedTemplateButton.callButton:type_name -> WAWebProtobufsE2E.HydratedTemplateButton.HydratedCallButton
	260, // 172: WAWebProtobufsE2E.PaymentBackground.mediaData:type_name -> WAWebProtobufsE2E.PaymentBackground.MediaData
	...
	170, // 177: WAWebProtobufsE2E.Message.senderKeyDistributionMessage:type_name -> WAWebProtobufsE2E.SenderKeyDistributionMessage
	103, // 178: WAWebProtobufsE2E.Message.imageMessage:type_name -> WAWebProtobufsE2E.ImageMessage
	169, // 179: WAWebProtobufsE2E.Message.contactMessage:type_name -> WAWebProtobufsE2E.ContactMessage
	168, // 180: WAWebProtobufsE2E.Message.locationMessage:type_name -> WAWebProtobufsE2E.LocationMessage
	98,  // 181: WAWebProtobufsE2E.Message.extendedTextMessage:type_name -> WAWebProtobufsE2E.ExtendedTextMessage
	164, // 182: WAWebProtobufsE2E.Message.documentMessage:type_name -> WAWebProtobufsE2E.DocumentMessage
	163, // 183: WAWebProtobufsE2E.Message.audioMessage:type_name -> WAWebProtobufsE2E.AudioMessage
	97,  // 184: WAWebProtobufsE2E.Message.videoMessage:type_name -> WAWebProtobufsE2E.VideoMessage
	162, // 185: WAWebProtobufsE2E.Message.call:type_name -> WAWebProtobufsE2E.Call
	161, // 186: WAWebProtobufsE2E.Message.chat:type_name -> WAWebProtobufsE2E.Chat
	95,  // 187: WAWebProtobufsE2E.Message.protocolMessage:type_name -> WAWebProtobufsE2E.ProtocolMessage
	148, // 188: WAWebProtobufsE2E.Message.contactsArrayMessage:type_name -> WAWebProtobufsE2E.ContactsArrayMessage
	91,  // 189: WAWebProtobufsE2E.Message.highlyStructuredMessage:type_name -> WAWebProtobufsE2E.HighlyStructuredMessage
	170, // 190: WAWebProtobufsE2E.Message.fastRatchetKeySenderKeyDistributionMessage:type_name -> WAWebProtobufsE2E.SenderKeyDistributionMessage
	147, // 191: WAWebProtobufsE2E.Message.sendPaymentMessage:type_name -> WAWebProtobufsE2E.SendPaymentMessage
	143, // 192: WAWebProtobufsE2E.Message.liveLocationMessage:type_name -> WAWebProtobufsE2E.LiveLocationMessage
	146, // 193: WAWebProtobufsE2E.Message.requestPaymentMessage:type_name -> WAWebProtobufsE2E.RequestPaymentMessage
	145, // 194: WAWebProtobufsE2E.Message.declinePaymentRequestMessage:type_name -> WAWebProtobufsE2E.DeclinePaymentRequestMessage
	144, // 195: WAWebProtobufsE2E.Message.cancelPaymentRequestMessage:type_name -> WAWebProtobufsE2E.CancelPaymentRequestMessage
	141, // 196: WAWebProtobufsE2E.Message.templateMessage:type_name -> WAWebProtobufsE2E.TemplateMessage
	142, // 197: WAWebProtobufsE2E.Message.stickerMessage:type_name -> WAWebProtobufsE2E.StickerMessage
	83,  // 198: WAWebProtobufsE2E.Message.groupInviteMessage:type_name -> WAWebProtobufsE2E.GroupInviteMessage
	140, // 199: WAWebProtobufsE2E.Message.templateButtonReplyMessage:type_name -> WAWebProtobufsE2E.TemplateButtonReplyMessage
	139, // 200: WAWebProtobufsE2E.Message.productMessage:type_name -> WAWebProtobufsE2E.ProductMessage
	135, // 201: WAWebProtobufsE2E.Message.deviceSentMessage:type_name -> WAWebProtobufsE2E.DeviceSentMessage
	107, // 202: WAWebProtobufsE2E.Message.messageContextInfo:type_name -> WAWebProtobufsE2E.MessageContextInfo
	87,  // 203: WAWebProtobufsE2E.Message.listMessage:type_name -> WAWebProtobufsE2E.ListMessage
	134, // 204: WAWebProtobufsE2E.Message.viewOnceMessage:type_name -> WAWebProtobufsE2E.FutureProofMessage
	88,  // 205: WAWebProtobufsE2E.Message.orderMessage:type_name -> WAWebProtobufsE2E.OrderMessage
	86,  // 206: WAWebProtobufsE2E.Message.listResponseMessage:type_name -> WAWebProtobufsE2E.ListResponseMessage
	134, // 207: WAWebProtobufsE2E.Message.ephemeralMessage:type_name -> WAWebProtobufsE2E.FutureProofMessage
	102, // 208: WAWebProtobufsE2E.Message.invoiceMessage:type_name -> WAWebProtobufsE2E.InvoiceMessage
	81,  // 209: WAWebProtobufsE2E.Message.buttonsMessage:type_name -> WAWebProtobufsE2E.ButtonsMessage
	80,  // 210: WAWebProtobufsE2E.Message.buttonsResponseMessage:type_name -> WAWebProtobufsE2E.ButtonsResponseMessage
	90,  // 211: WAWebProtobufsE2E.Message.paymentInviteMessage:type_name -> WAWebProtobufsE2E.PaymentInviteMessage
	85,  // 212: WAWebProtobufsE2E.Message.interactiveMessage:type_name -> WAWebProtobufsE2E.InteractiveMessage
	133, // 213: WAWebProtobufsE2E.Message.reactionMessage:type_name -> WAWebProtobufsE2E.ReactionMessage
	132, // 214: WAWebProtobufsE2E.Message.stickerSyncRmrMessage:type_name -> WAWebProtobufsE2E.StickerSyncRMRMessage
	84,  // 215: WAWebProtobufsE2E.Message.interactiveResponseMessage:type_name -> WAWebProtobufsE2E.InteractiveResponseMessage
	131, // 216: WAWebProtobufsE2E.Message.pollCreationMessage:type_name -> WAWebProtobufsE2E.PollCreationMessage
	130, // 217: WAWebProtobufsE2E.Message.pollUpdateMessage:type_name -> WAWebProtobufsE2E.PollUpdateMessage
	123, // 218: WAWebProtobufsE2E.Message.keepInChatMessage:type_name -> WAWebProtobufsE2E.KeepInChatMessage
	134, // 219: WAWebProtobufsE2E.Message.documentWithCaptionMessage:type_name -> WAWebProtobufsE2E.FutureProofMessage
	136, // 220: WAWebProtobufsE2E.Message.requestPhoneNumberMessage:type_name -> WAWebProtobufsE2E.RequestPhoneNumberMessage
	134, // 221: WAWebProtobufsE2E.Message.viewOnceMessageV2:type_name -> WAWebProtobufsE2E.FutureProofMessage
	122, // 222: WAWebProtobufsE2E.Message.encReactionMessage:type_name -> WAWebProtobufsE2E.EncReactionMessage
	134, // 223: WAWebProtobufsE2E.Message.editedMessage:type_name -> WAWebProtobufsE2E.FutureProofMessage
	134, // 224: WAWebProtobufsE2E.Message.viewOnceMessageV2Extension:type_name -> WAWebProtobufsE2E.FutureProofMessage
	131, // 225: WAWebProtobufsE2E.Message.pollCreationMessageV2:type_name -> WAWebProtobufsE2E.PollCreationMessage
	76,  // 226: WAWebProtobufsE2E.Message.scheduledCallCreationMessage:type_name -> WAWebProtobufsE2E.ScheduledCallCreationMessage
	134, // 227: WAWebProtobufsE2E.Message.groupMentionedMessage:type_name -> WAWebProtobufsE2E.FutureProofMessage
	78,  // 228: WAWebProtobufsE2E.Message.pinInChatMessage:type_name -> WAWebProtobufsE2E.PinInChatMessage
	131, // 229: WAWebProtobufsE2E.Message.pollCreationMessageV3:type_name -> WAWebProtobufsE2E.PollCreationMessage
	75,  // 230: WAWebProtobufsE2E.Message.scheduledCallEditMessage:type_name -> WAWebProtobufsE2E.ScheduledCallEditMessage
	97,  // 231: WAWebProtobufsE2E.Message.ptvMessage:type_name -> WAWebProtobufsE2E.VideoMessage
	134, // 232: WAWebProtobufsE2E.Message.botInvokeMessage:type_name -> WAWebProtobufsE2E.FutureProofMessage
	74,  // 233: WAWebProtobufsE2E.Message.callLogMesssage:type_name -> WAWebProtobufsE2E.CallLogMessage
	117, // 234: WAWebProtobufsE2E.Message.messageHistoryBundle:type_name -> WAWebProtobufsE2E.MessageHistoryBundle
	121, // 235: WAWebProtobufsE2E.Message.encCommentMessage:type_name -> WAWebProtobufsE2E.EncCommentMessage
	73,  // 236: WAWebProtobufsE2E.Message.bcallMessage:type_name -> WAWebProtobufsE2E.BCallMessage
	134, // 237: WAWebProtobufsE2E.Message.lottieStickerMessage:type_name -> WAWebProtobufsE2E.FutureProofMessage
	119, // 238: WAWebProtobufsE2E.Message.eventMessage:type_name -> WAWebProtobufsE2E.EventMessage
	118, // 239: WAWebProtobufsE2E.Message.encEventResponseMessage:type_name -> WAWebProtobufsE2E.EncEventResponseMessage
	120, // 240: WAWebProtobufsE2E.Message.commentMessage:type_name -> WAWebProtobufsE2E.CommentMessage
	138, // 241: WAWebProtobufsE2E.Message.newsletterAdminInviteMessage:type_name -> WAWebProtobufsE2E.NewsletterAdminInviteMessage
	72,  // 242: WAWebProtobufsE2E.Message.placeholderMessage:type_name -> WAWebProtobufsE2E.PlaceholderMessage
	82,  // 243: WAWebProtobufsE2E.Message.secretEncryptedMessage:type_name -> WAWebProtobufsE2E.SecretEncryptedMessage
	114, // 244: WAWebProtobufsE2E.Message.albumMessage:type_name -> WAWebProtobufsE2E.AlbumMessage
	134, // 245: WAWebProtobufsE2E.Message.eventCoverImage:type_name -> WAWebProtobufsE2E.FutureProofMessage
	71,  // 246: WAWebProtobufsE2E.Message.stickerPackMessage:type_name -> WAWebProtobufsE2E.StickerPackMessage
	134, // 247: WAWebProtobufsE2E.Message.statusMentionMessage:type_name -> WAWebProtobufsE2E.FutureProofMessage
	126, // 248: WAWebProtobufsE2E.Message.pollResultSnapshotMessage:type_name -> WAWebProtobufsE2E.PollResultSnapshotMessage
	134, // 249: WAWebProtobufsE2E.Message.pollCreationOptionImageMessage:type_name -> WAWebProtobufsE2E.FutureProofMessage
	134, // 250: WAWebProtobufsE2E.Message.associatedChildMessage:type_name -> WAWebProtobufsE2E.FutureProofMessage
	134, // 251: WAWebProtobufsE2E.Message.groupStatusMentionMessage:type_name -> WAWebProtobufsE2E.FutureProofMessage
	134, // 252: WAWebProtobufsE2E.Message.pollCreationMessageV4:type_name -> WAWebProtobufsE2E.FutureProofMessage
	134, // 253: WAWebProtobufsE2E.Message.statusAddYours:type_name -> WAWebProtobufsE2E.FutureProofMessage
	134, // 254: WAWebProtobufsE2E.Message.groupStatusMessage:type_name -> WAWebProtobufsE2E.FutureProofMessage
	191, // 255: WAWebProtobufsE2E.Message.richResponseMessage:type_name -> WAWebProtobufsE2E.AIRichResponseMessage
	101, // 256: WAWebProtobufsE2E.Message.statusNotificationMessage:type_name -> WAWebProtobufsE2E.StatusNotificationMessage
	134, // 257: WAWebProtobufsE2E.Message.limitSharingMessage:type_name -> WAWebProtobufsE2E.FutureProofMessage
	134, // 258: WAWebProtobufsE2E.Message.botTaskMessage:type_name -> WAWebProtobufsE2E.FutureProofMessage
	134, // 259: WAWebProtobufsE2E.Message.questionMessage:type_name -> WAWebProtobufsE2E.FutureProofMessage
	116, // 260: WAWebProtobufsE2E.Message.messageHistoryNotice:type_name -> WAWebProtobufsE2E.MessageHistoryNotice
	134, // 261: WAWebProtobufsE2E.Message.groupStatusMessageV2:type_name -> WAWebProtobufsE2E.FutureProofMessage
	134, // 262: WAWebProtobufsE2E.Message.botForwardedMessage:type_name -> WAWebProtobufsE2E.FutureProofMessage
	125, // 263: WAWebProtobufsE2E.Message.statusQuestionAnswerMessage:type_name -> WAWebProtobufsE2E.StatusQuestionAnswerMessage
	134, // 264: WAWebProtobufsE2E.Message.questionReplyMessage:type_name -> WAWebProtobufsE2E.FutureProofMessage
	124, // 265: WAWebProtobufsE2E.Message.questionResponseMessage:type_name -> WAWebProtobufsE2E.QuestionResponseMessage
	89,  // 266: WAWebProtobufsE2E.Message.statusQuotedMessage:type_name -> WAWebProtobufsE2E.StatusQuotedMessage
	79,  // 267: WAWebProtobufsE2E.Message.statusStickerInteractionMessage:type_name -> WAWebProtobufsE2E.StatusStickerInteractionMessage
	131, // 268: WAWebProtobufsE2E.Message.pollCreationMessageV5:type_name -> WAWebProtobufsE2E.PollCreationMessage
	137, // 269: WAWebProtobufsE2E.Message.newsletterFollowerInviteMessageV2:type_name -> WAWebProtobufsE2E.NewsletterFollowerInviteMessage
	126, // 270: WAWebProtobufsE2E.Message.pollResultSnapshotMessageV3:type_name -> WAWebProtobufsE2E.PollResultSnapshotMessage
	134, // 271: WAWebProtobufsE2E.Message.newsletterAdminProfileMessage:type_name -> WAWebProtobufsE2E.FutureProofMessage
	134, // 272: WAWebProtobufsE2E.Message.newsletterAdminProfileMessageV2:type_name -> WAWebProtobufsE2E.FutureProofMessage
	134, // 273: WAWebProtobufsE2E.Message.spoilerMessage:type_name -> WAWebProtobufsE2E.FutureProofMessage
	134, // 274: WAWebProtobufsE2E.Message.pollCreationMessageV6:type_name -> WAWebProtobufsE2E.FutureProofMessage
	104, // 275: WAWebProtobufsE2E.AlbumMessage.contextInfo:type_name -> WAWebProtobufsE2E.ContextInfo
	104, // 276: WAWebProtobufsE2E.MessageHistoryNotice.contextInfo:type_name -> WAWebProtobufsE2E.ContextInfo
	115, // 277: WAWebProtobufsE2E.MessageHistoryNotice.messageHistoryMetadata:type_name -> WAWebProtobufsE2E.MessageHistoryMetadata
	104, // 278: WAWebProtobufsE2E.MessageHistoryBundle.contextInfo:type_name -> WAWebProtobufsE2E.ContextInfo
	115, // 279: WAWebProtobufsE2E.MessageHistoryBundle.messageHistoryMetadata:type_name -> WAWebProtobufsE2E.MessageHistoryMetadata
	275, // 280: WAWebProtobufsE2E.EncEventResponseMessage.eventCreationMessageKey:type_name -> WACommon.MessageKey
	104, // 281: WAWebProtobufsE2E.EventMessage.contextInfo:type_name -> WAWebProtobufsE2E.ContextInfo
	168, // 282: WAWebProtobufsE2E.EventMessage.location:type_name -> WAWebProtobufsE2E.LocationMessage
	113, // 283: WAWebProtobufsE2E.CommentMessage.message:type_name -> WAWebProtobufsE2E.Message
	275, // 284: WAWebProtobufsE2E.CommentMessage.targetMessageKey:type_name -> WACommon.MessageKey
	275, // 285: WAWebProtobufsE2E.EncCommentMessage.targetMessageKey:type_name -> WACommon.MessageKey
	275, // 286: WAWebProtobufsE2E.EncReactionMessage.targetMessageKey:type_name -> WACommon.MessageKey
	275, // 287: WAWebProtobufsE2E.KeepInChatMessage.key:type_name -> WACommon.MessageKey
	6,   // 288: WAWebProtobufsE2E.KeepInChatMessage.keepType:type_name -> WAWebProtobufsE2E.KeepType
	275, // 289: WAWebProtobufsE2E.QuestionResponseMessage.key:type_name -> WACommon.MessageKey
	275, // 290: WAWebProtobufsE2E.StatusQuestionAnswerMessage.key:type_name -> WACommon.MessageKey
	261, // 291: WAWebProtobufsE2E.PollResultSnapshotMessage.pollVotes:type_name -> WAWebProtobufsE2E.PollResultSnapshotMessage.PollVote
	104, // 292: WAWebProtobufsE2E.PollResultSnapshotMessage.contextInfo:type_name -> WAWebProtobufsE2E.ContextInfo
	0,   // 293: WAWebProtobufsE2E.PollResultSnapshotMessage.pollType:type_name -> WAWebProtobufsE2E.PollType
	275, // 294: WAWebProtobufsE2E.PollUpdateMessage.pollCreationMessageKey:type_name -> WACommon.MessageKey
	128, // 295: WAWebProtobufsE2E.PollUpdateMessage.vote:type_name -> WAWebProtobufsE2E.PollEncValue
	129, // 296: WAWebProtobufsE2E.PollUpdateMessage.metadata:type_name -> WAWebProtobufsE2E.PollUpdateMessageMetadata
	262, // 297: WAWebProtobufsE2E.PollCreationMessage.options:type_name -> WAWebProtobufsE2E.PollCreationMessage.Option
	104, // 298: WAWebProtobufsE2E.PollCreationMessage.contextInfo:type_name -> WAWebProtobufsE2E.ContextInfo
	...
	262, // 301: WAWebProtobufsE2E.PollCreationMessage.correctAnswer:type_name -> WAWebProtobufsE2E.PollCreationMessage.Option
	275, // 302: WAWebProtobufsE2E.ReactionMessage.key:type_name -> WACommon.MessageKey
	113, // 303: WAWebProtobufsE2E.FutureProofMessage.message:type_name -> WAWebProtobufsE2E.Message
	113, // 304: WAWebProtobufsE2E.DeviceSentMessage.message:type_name -> WAWebProtobufsE2E.Message
	104, // 305: WAWebProtobufsE2E.RequestPhoneNumberMessage.contextInfo:type_name -> WAWebProtobufsE2E.ContextInfo
	104, // 306: WAWebProtobufsE2E.NewsletterFollowerInviteMessage.contextInfo:type_name -> WAWebProtobufsE2E.ContextInfo
	104, // 307: WAWebProtobufsE2E.NewsletterAdminInviteMessage.contextInfo:type_name -> WAWebProtobufsE2E.ContextInfo
	263, // 308: WAWebProtobufsE2E.ProductMessage.product:type_name -> WAWebProtobufsE2E.ProductMessage.ProductSnapshot
	264, // 309: WAWebProtobufsE2E.ProductMessage.catalog:type_name -> WAWebProtobufsE2E.ProductMessage.CatalogSnapshot
	104, // 310: WAWebProtobufsE2E.ProductMessage.contextInfo:type_name -> WAWebProtobufsE2E.ContextInfo
	104, // 311: WAWebProtobufsE2E.TemplateButtonReplyMessage.contextInfo:type_name -> WAWebProtobufsE2E.ContextInfo
	266, // 312: WAWebProtobufsE2E.TemplateMessage.fourRowTemplate:type_name -> WAWebProtobufsE2E.TemplateMessage.FourRowTemplate
	265, // 313: WAWebProtobufsE2E.TemplateMessage.hydratedFourRowTemplate:type_name -> WAWebProtobufsE2E.TemplateMessage.HydratedFourRowTemplate
	85,  // 314: WAWebProtobufsE2E.TemplateMessage.interactiveMessageTemplate:type_name -> WAWebProtobufsE2E.InteractiveMessage
	104, // 315: WAWebProtobufsE2E.TemplateMessage.contextInfo:type_name -> WAWebProtobufsE2E.ContextInfo
	265, // 316: WAWebProtobufsE2E.TemplateMessage.hydratedTemplate:type_name -> WAWebProtobufsE2E.TemplateMessage.HydratedFourRowTemplate
	104, // 317: WAWebProtobufsE2E.StickerMessage.contextInfo:type_name -> WAWebProtobufsE2E.ContextInfo
	104, // 318: WAWebProtobufsE2E.LiveLocationMessage.contextInfo:type_name -> WAWebProtobufsE2E.ContextInfo
	275, // 319: WAWebProtobufsE2E.CancelPaymentRequestMessage.key:type_name -> WACommon.MessageKey
	275, // 320: WAWebProtobufsE2E.DeclinePaymentRequestMessage.key:type_name -> WACommon.MessageKey
	113, // 321: WAWebProtobufsE2E.RequestPaymentMessage.noteMessage:type_name -> WAWebProtobufsE2E.Message
	181, // 322: WAWebProtobufsE2E.RequestPaymentMessage.amount:type_name -> WAWebProtobufsE2E.Money
	110, // 323: WAWebProtobufsE2E.RequestPaymentMessage.background:type_name -> WAWebProtobufsE2E.PaymentBackground
	113, // 324: WAWebProtobufsE2E.SendPaymentMessage.noteMessage:type_name -> WAWebProtobufsE2E.Message
	275, // 325: WAWebProtobufsE2E.SendPaymentMessage.requestMessageKey:type_name -> WACommon.MessageKey
	110, // 326: WAWebProtobufsE2E.SendPaymentMessage.background:type_name -> WAWebProtobufsE2E.PaymentBackground
	169, // 327: WAWebProtobufsE2E.ContactsArrayMessage.contacts:type_name -> WAWebProtobufsE2E.ContactMessage
	104, // 328: WAWebProtobufsE2E.ContactsArrayMessage.contextInfo:type_name -> WAWebProtobufsE2E.ContextInfo
	157, // 329: WAWebProtobufsE2E.AppStateSyncKeyRequest.keyIDs:type_name -> WAWebProtobufsE2E.AppStateSyncKeyId
	158, // 330: WAWebProtobufsE2E.AppStateSyncKeyShare.keys:type_name -> WAWebProtobufsE2E.AppStateSyncKey
	156, // 331: WAWebProtobufsE2E.AppStateSyncKeyData.fingerprint:type_name -> WAWebProtobufsE2E.AppStateSyncKeyFingerprint
	157, // 332: WAWebProtobufsE2E.AppStateSyncKey.keyID:type_name -> WAWebProtobufsE2E.AppStateSyncKeyId
	155, // 333: WAWebProtobufsE2E.AppStateSyncKey.keyData:type_name -> WAWebProtobufsE2E.AppStateSyncKeyData
	3,   // 334: WAWebProtobufsE2E.HistorySyncNotification.syncType:type_name -> WAWebProtobufsE2E.HistorySyncType
	151, // 335: WAWebProtobufsE2E.HistorySyncNotification.fullHistorySyncOnDemandRequestMetadata:type_name -> WAWebProtobufsE2E.FullHistorySyncOnDemandRequestMetadata
	160, // 336: WAWebProtobufsE2E.HistorySyncNotification.messageAccessStatus:type_name -> WAWebProtobufsE2E.HistorySyncMessageAccessStatus
	104, // 337: WAWebProtobufsE2E.Call.contextInfo:type_name -> WAWebProtobufsE2E.ContextInfo
	107, // 338: WAWebProtobufsE2E.Call.messageContextInfo:type_name -> WAWebProtobufsE2E.MessageContextInfo
	104, // 339: WAWebProtobufsE2E.AudioMessage.contextInfo:type_name -> WAWebProtobufsE2E.ContextInfo
	104, // 340: WAWebProtobufsE2E.DocumentMessage.contextInfo:type_name -> WAWebProtobufsE2E.ContextInfo
	104, // 341: WAWebProtobufsE2E.LocationMessage.contextInfo:type_name -> WAWebProtobufsE2E.ContextInfo
	104, // 342: WAWebProtobufsE2E.ContactMessage.contextInfo:type_name -> WAWebProtobufsE2E.ContextInfo
	4,   // 343: WAWebProtobufsE2E.MediaDomainInfo.mediaKeyDomain:type_name -> WAWebProtobufsE2E.MediaKeyDomain
	283, // 344: WAWebProtobufsE2E.DeviceListMetadata.senderAccountType:type_name -> WAAdv.ADVEncryptionType
	283, // 345: WAWebProtobufsE2E.DeviceListMetadata.receiverAccountType:type_name -> WAAdv.ADVEncryptionType
	113, // 346: WAWebProtobufsE2E.EmbeddedMessage.message:type_name -> WAWebProtobufsE2E.Message
	174, // 347: WAWebProtobufsE2E.EmbeddedContent.embeddedMessage:type_name -> WAWebProtobufsE2E.EmbeddedMessage
	175, // 348: WAWebProtobufsE2E.EmbeddedContent.embeddedMusic:type_name -> WAWebProtobufsE2E.EmbeddedMusic
	269, // 349: WAWebProtobufsE2E.TemplateButton.quickReplyButton:type_name -> WAWebProtobufsE2E.TemplateButton.QuickReplyButton
	268, // 350: WAWebProtobufsE2E.TemplateButton.urlButton:type_name -> WAWebProtobufsE2E.TemplateButton.URLButton
	267, // 351: WAWebProtobufsE2E.TemplateButton.callButton:type_name -> WAWebProtobufsE2E.TemplateButton.CallButton
	271, // 352: WAWebProtobufsE2E.MsgOpaqueData.pollOptions:type_name -> WAWebProtobufsE2E.MsgOpaqueData.PollOption
	128, // 353: WAWebProtobufsE2E.MsgOpaqueData.encPollVote:type_name -> WAWebProtobufsE2E.PollEncValue
	69,  // 354: WAWebProtobufsE2E.MsgOpaqueData.pollContentType:type_name -> WAWebProtobufsE2E.MsgOpaqueData.PollContentType
	70,  // 355: WAWebProtobufsE2E.MsgOpaqueData.pollType:type_name -> WAWebProtobufsE2E.MsgOpaqueData.PollType
	273, // 356: WAWebProtobufsE2E.MsgOpaqueData.pollVotesSnapshot:type_name -> WAWebProtobufsE2E.MsgOpaqueData.PollVotesSnapshot
	270, // 357: WAWebProtobufsE2E.MsgOpaqueData.eventLocation:type_name -> WAWebProtobufsE2E.MsgOpaqueData.EventLocation
	182, // 358: WAWebProtobufsE2E.MsgRowOpaqueData.currentMsg:type_name -> WAWebProtobufsE2E.MsgOpaqueData
	182, // 359: WAWebProtobufsE2E.MsgRowOpaqueData.quotedMsg:type_name -> WAWebProtobufsE2E.MsgOpaqueData
	274, // 360: WAWebProtobufsE2E.UrlTrackingMap.urlTrackingMapElements:type_name -> WAWebProtobufsE2E.UrlTrackingMap.UrlTrackingMapElement
	284, // 361: WAWebProtobufsE2E.AIRichResponseMessage.messageType:type_name -> WAWebProtobufsAICommon.AIRichResponseMessageType
	285, // 362: WAWebProtobufsE2E.AIRichResponseMessage.submessages:type_name -> WAWebProtobufsAICommon.AIRichResponseSubMessage
	286, // 363: WAWebProtobufsE2E.AIRichResponseMessage.unifiedResponse:type_name -> WAWebProtobufsAICommon.AIRichResponseUnifiedResponse
	104, // 364: WAWebProtobufsE2E.AIRichResponseMessage.contextInfo:type_name -> WAWebProtobufsE2E.ContextInfo
	275, // 365: WAWebProtobufsE2E.AIQueryFanout.messageKey:type_name -> WACommon.MessageKey
	113, // 366: WAWebProtobufsE2E.AIQueryFanout.message:type_name -> WAWebProtobufsE2E.Message
	10,  // 367: WAWebProtobufsE2E.CallLogMessage.CallParticipant.callOutcome:type_name -> WAWebProtobufsE2E.CallLogMessage.CallOutcome
	197, // 368: WAWebProtobufsE2E.ButtonsMessage.Button.buttonText:type_name -> WAWebProtobufsE2E.ButtonsMessage.Button.ButtonText
	19,  // 369: WAWebProtobufsE2E.ButtonsMessage.Button.type:type_name -> WAWebProtobufsE2E.ButtonsMessage.Button.Type
	196, // 370: WAWebProtobufsE2E.ButtonsMessage.Button.nativeFlowInfo:type_name -> WAWebProtobufsE2E.ButtonsMessage.Button.NativeFlowInfo
	22,  // 371: WAWebProtobufsE2E.InteractiveResponseMessage.Body.format:type_name -> WAWebProtobufsE2E.InteractiveResponseMessage.Body.Format
	85,  // 372: WAWebProtobufsE2E.InteractiveMessage.CarouselMessage.cards:type_name -> WAWebProtobufsE2E.InteractiveMessage
	23,  // 373: WAWebProtobufsE2E.InteractiveMessage.CarouselMessage.carouselCardType:type_name -> WAWebProtobufsE2E.InteractiveMessage.CarouselMessage.CarouselCardType
	24,  // 374: WAWebProtobufsE2E.InteractiveMessage.ShopMessage.surface:type_name -> WAWebProtobufsE2E.InteractiveMessage.ShopMessage.Surface
	208, // 375: WAWebProtobufsE2E.InteractiveMessage.NativeFlowMessage.buttons:type_name -> WAWebProtobufsE2E.InteractiveMessage.NativeFlowMessage.NativeFlowButton
	163, // 376: WAWebProtobufsE2E.InteractiveMessage.Footer.audioMessage:type_name -> WAWebProtobufsE2E.AudioMessage
	164, // 377: WAWebProtobufsE2E.InteractiveMessage.Header.documentMessage:type_name -> WAWebProtobufsE2E.DocumentMessage
	103, // 378: WAWebProtobufsE2E.InteractiveMessage.Header.imageMessage:type_name -> WAWebProtobufsE2E.ImageMessage
	97,  // 379: WAWebProtobufsE2E.InteractiveMessage.Header.videoMessage:type_name -> WAWebProtobufsE2E.VideoMessage
	168, // 380: WAWebProtobufsE2E.InteractiveMessage.Header.locationMessage:type_name -> WAWebProtobufsE2E.LocationMessage
	139, // 381: WAWebProtobufsE2E.InteractiveMessage.Header.productMessage:type_name -> WAWebProtobufsE2E.ProductMessage
	212, // 382: WAWebProtobufsE2E.ListMessage.ProductListInfo.productSections:type_name -> WAWebProtobufsE2E.ListMessage.ProductSection
	211, // 383: WAWebProtobufsE2E.ListMessage.ProductListInfo.headerImage:type_name -> WAWebProtobufsE2E.ListMessage.ProductListHeaderImage
	213, // 384: WAWebProtobufsE2E.ListMessage.ProductSection.products:type_name -> WAWebProtobufsE2E.ListMessage.Product
	215, // 385: WAWebProtobufsE2E.ListMessage.Section.rows:type_name -> WAWebProtobufsE2E.ListMessage.Row
	218, // 386: WAWebProtobufsE2E.HighlyStructuredMessage.HSMLocalizableParameter.currency:type_name -> WAWebProtobufsE2E.HighlyStructuredMessage.HSMLocalizableParameter.HSMCurrency
	217, // 387: WAWebProtobufsE2E.HighlyStructuredMessage.HSMLocalizableParameter.dateTime:type_name -> WAWebProtobufsE2E.HighlyStructuredMessage.HSMLocalizableParameter.HSMDateTime
	219, // 388: WAWebProtobufsE2E.HighlyStructuredMessage.HSMLocalizableParameter.HSMDateTime.component:type_name -> WAWebProtobufsE2E.HighlyStructuredMessage.HSMLocalizableParameter.HSMDateTime.HSMDateTimeComponent
	220, // 389: WAWebProtobufsE2E.HighlyStructuredMessage.HSMLocalizableParameter.HSMDateTime.unixEpoch:type_name -> WAWebProtobufsE2E.HighlyStructuredMessage.HSMLocalizableParameter.HSMDateTime.HSMDateTimeUnixEpoch
	32,  // 390: WAWebProtobufsE2E.HighlyStructuredMessage.HSMLocalizableParameter.HSMDateTime.HSMDateTimeComponent.dayOfWeek:type_name -> WAWebProtobufsE2E.HighlyStructuredMessage.HSMLocalizableParameter.HSMDateTime.HSMDateTimeComponent.DayOfWeekType
	31,  // 391: WAWebProtobufsE2E.HighlyStructuredMessage.HSMLocalizableParameter.HSMDateTime.HSMDateTimeComponent.calendar:type_name -> WAWebProtobufsE2E.HighlyStructuredMessage.HSMLocalizableParameter.HSMDateTime.HSMDateTimeComponent.CalendarType
	287, // 392: WAWebProtobufsE2E.PeerDataOperationRequestResponseMessage.PeerDataOperationResult.mediaUploadResult:type_name -> WAMmsRetry.MediaRetryNotification.ResultType
	142, // 393: WAWebProtobufsE2E.PeerDataOperationRequestResponseMessage.PeerDataOperationResult.stickerMessage:type_name -> WAWebProtobufsE2E.StickerMessage
	230, // 394: WAWebProtobufsE2E.PeerDataOperationRequestResponseMessage.PeerDataOperationResult.linkPreviewResponse:type_name -> WAWebProtobufsE2E.PeerDataOperationRequestResponseMessage.PeerDataOperationResult.LinkPreviewResponse
	229, // 395: WAWebProtobufsE2E.PeerDataOperationRequestResponseMessage.PeerDataOperationResult.placeholderMessageResendResponse:type_name -> WAWebProtobufsE2E.PeerDataOperationRequestResponseMessage.PeerDataOperationResult.PlaceholderMessageResendResponse
	227, // 396: WAWebProtobufsE2E.PeerDataOperationRequestResponseMessage.PeerDataOperationResult.waffleNonceFetchRequestResponse:type_name -> WAWebProtobufsE2E.PeerDataOperationRequestResponseMessage.PeerDataOperationResult.WaffleNonceFetchResponse
	228, // 397: WAWebProtobufsE2E.PeerDataOperationRequestResponseMessage.PeerDataOperationResult.fullHistorySyncOnDemandRequestResponse:type_name -> WAWebProtobufsE2E.PeerDataOperationRequestResponseMessage.PeerDataOperationResult.FullHistorySyncOnDemandRequestResponse
	225, // 398: WAWebProtobufsE2E.PeerDataOperationRequestResponseMessage.PeerDataOperationResult.companionMetaNonceFetchRequestResponse:type_name -> WAWebProtobufsE2E.PeerDataOperationRequestResponseMessage.PeerDataOperationResult.CompanionMetaNonceFetchResponse
	223, // 399: WAWebProtobufsE2E.PeerDataOperationRequestResponseMessage.PeerDataOperationResult.syncdSnapshotFatalRecoveryResponse:type_name -> WAWebProtobufsE2E.PeerDataOperationRequestResponseMessage.PeerDataOperationResult.SyncDSnapshotFatalRecoveryResponse
	224, // 400: WAWebProtobufsE2E.PeerDataOperationRequestResponseMessage.PeerDataOperationResult.companionCanonicalUserNonceFetchRequestResponse:type_name -> WAWebProtobufsE2E.PeerDataOperationRequestResponseMessage.PeerDataOperationResult.CompanionCanonicalUserNonceFetchResponse
	222, // 401: WAWebProtobufsE2E.PeerDataOperationRequestResponseMessage.PeerDataOperationResult.historySyncChunkRetryResponse:type_name -> WAWebProtobufsE2E.PeerDataOperationRequestResponseMessage.PeerDataOperationResult.HistorySyncChunkRetryResponse
	226, // 402: WAWebProtobufsE2E.PeerDataOperationRequestResponseMessage.PeerDataOperationResult.flowResponsesCsvBundle:type_name -> WAWebProtobufsE2E.PeerDataOperationRequestResponseMessage.PeerDataOperationResult.FlowResponsesCsvBundle
	3,   // 403: WAWebProtobufsE2E.PeerDataOperationRequestResponseMessage.PeerDataOperationResult.HistorySyncChunkRetryResponse.syncType:type_name -> WAWebProtobufsE2E.HistorySyncType
	33,  // 404: WAWebProtobufsE2E.PeerDataOperationRequestResponseMessage.PeerDataOperationResult.HistorySyncChunkRetryResponse.responseCode:type_name -> WAWebProtobufsE2E.PeerDataOperationRequestResponseMessage.PeerDataOperationResult.HistorySyncChunkRetryResponseCode
	151, // 405: WAWebProtobufsE2E.PeerDataOperationRequestResponseMessage.PeerDataOperationResult.FullHistorySyncOnDemandRequestResponse.requestMetadata:type_name -> WAWebProtobufsE2E.FullHistorySyncOnDemandRequestMetadata
	34,  // 406: WAWebProtobufsE2E.PeerDataOperationRequestResponseMessage.PeerDataOperationResult.FullHistorySyncOnDemandRequestResponse.responseCode:type_name -> WAWebProtobufsE2E.PeerDataOperationRequestResponseMessage.PeerDataOperationResult.FullHistorySyncOnDemandResponseCode
	232, // 407: WAWebProtobufsE2E.PeerDataOperationRequestResponseMessage.PeerDataOperationResult.LinkPreviewResponse.hqThumbnail:type_name -> WAWebProtobufsE2E.PeerDataOperationRequestResponseMessage.PeerDataOperationResult.LinkPreviewResponse.LinkPreviewHighQualityThumbnail
	231, // 408: WAWebProtobufsE2E.PeerDataOperationRequestResponseMessage.PeerDataOperationResult.LinkPreviewResponse.previewMetadata:type_name -> WAWebProtobufsE2E.PeerDataOperationRequestResponseMessage.PeerDataOperationResult.LinkPreviewResponse.PaymentLinkPreviewMetadata
	35,  // 409: WAWebProtobufsE2E.PeerDataOperationRequestMessage.GalaxyFlowAction.type:type_name -> WAWebProtobufsE2E.PeerDataOperationRequestMessage.GalaxyFlowAction.GalaxyFlowActionType
	3,   // 410: WAWebProtobufsE2E.PeerDataOperationRequestMessage.HistorySyncChunkRetryRequest.syncType:type_name -> WAWebProtobufsE2E.HistorySyncType
	275, // 411: WAWebProtobufsE2E.PeerDataOperationRequestMessage.PlaceholderMessageResendRequest.messageKey:type_name -> WACommon.MessageKey
	151, // 412: WAWebProtobufsE2E.PeerDataOperationRequestMessage.FullHistorySyncOnDemandRequest.requestMetadata:type_name -> WAWebProtobufsE2E.FullHistorySyncOnDemandRequestMetadata
	288, // 413: WAWebProtobufsE2E.PeerDataOperationRequestMessage.FullHistorySyncOnDemandRequest.historySyncConfig:type_name -> WACompanionReg.DeviceProps.HistorySyncConfig
	150, // 414: WAWebProtobufsE2E.PeerDataOperationRequestMessage.FullHistorySyncOnDemandRequest.fullHistorySyncOnDemandConfig:type_name -> WAWebProtobufsE2E.FullHistorySyncOnDemandConfig
	45,  // 415: WAWebProtobufsE2E.PaymentLinkMetadata.PaymentLinkHeader.headerType:type_name -> WAWebProtobufsE2E.PaymentLinkMetadata.PaymentLinkHeader.PaymentLinkHeaderType
	54,  // 416: WAWebProtobufsE2E.ContextInfo.StatusAudienceMetadata.audienceType:type_name -> WAWebProtobufsE2E.ContextInfo.StatusAudienceMetadata.AudienceType
	256, // 417: WAWebProtobufsE2E.ContextInfo.DataSharingContext.parameters:type_name -> WAWebProtobufsE2E.ContextInfo.DataSharingContext.Parameters
	56,  // 418: WAWebProtobufsE2E.ContextInfo.ForwardedNewsletterMessageInfo.contentType:type_name -> WAWebProtobufsE2E.ContextInfo.ForwardedNewsletterMessageInfo.ContentType
	58,  // 419: WAWebProtobufsE2E.ContextInfo.ExternalAdReplyInfo.mediaType:type_name -> WAWebProtobufsE2E.ContextInfo.ExternalAdReplyInfo.MediaType
	57,  // 420: WAWebProtobufsE2E.ContextInfo.ExternalAdReplyInfo.adType:type_name -> WAWebProtobufsE2E.ContextInfo.ExternalAdReplyInfo.AdType
	59,  // 421: WAWebProtobufsE2E.ContextInfo.AdReplyInfo.mediaType:type_name -> WAWebProtobufsE2E.ContextInfo.AdReplyInfo.MediaType
	113, // 422: WAWebProtobufsE2E.ContextInfo.QuestionReplyQuotedMessage.quotedQuestion:type_name -> WAWebProtobufsE2E.Message
	113, // 423: WAWebProtobufsE2E.ContextInfo.QuestionReplyQuotedMessage.quotedResponse:type_name -> WAWebProtobufsE2E.Message
	256, // 424: WAWebProtobufsE2E.ContextInfo.DataSharingContext.Parameters.contents:type_name -> WAWebProtobufsE2E.ContextInfo.DataSharingContext.Parameters
	64,  // 425: WAWebProtobufsE2E.HydratedTemplateButton.HydratedURLButton.webviewPresentation:type_name -> WAWebProtobufsE2E.HydratedTemplateButton.HydratedURLButton.WebviewPresentationType
	103, // 426: WAWebProtobufsE2E.ProductMessage.ProductSnapshot.productImage:type_name -> WAWebProtobufsE2E.ImageMessage
	103, // 427: WAWebProtobufsE2E.ProductMessage.CatalogSnapshot.catalogImage:type_name -> WAWebProtobufsE2E.ImageMessage
	164, // 428: WAWebProtobufsE2E.TemplateMessage.HydratedFourRowTemplate.documentMessage:type_name -> WAWebProtobufsE2E.DocumentMessage
	103, // 429: WAWebProtobufsE2E.TemplateMessage.HydratedFourRowTemplate.imageMessage:type_name -> WAWebProtobufsE2E.ImageMessage
	97,  // 430: WAWebProtobufsE2E.TemplateMessage.HydratedFourRowTemplate.videoMessage:type_name -> WAWebProtobufsE2E.VideoMessage
	168, // 431: WAWebProtobufsE2E.TemplateMessage.HydratedFourRowTemplate.locationMessage:type_name -> WAWebProtobufsE2E.LocationMessage
	109, // 432: WAWebProtobufsE2E.TemplateMessage.HydratedFourRowTemplate.hydratedButtons:type_name -> WAWebProtobufsE2E.HydratedTemplateButton
	164, // 433: WAWebProtobufsE2E.TemplateMessage.FourRowTemplate.documentMessage:type_name -> WAWebProtobufsE2E.DocumentMessage
	91,  // 434: WAWebProtobufsE2E.TemplateMessage.FourRowTemplate.highlyStructuredMessage:type_name -> WAWebProtobufsE2E.HighlyStructuredMessage
	103, // 435: WAWebProtobufsE2E.TemplateMessage.FourRowTemplate.imageMessage:type_name -> WAWebProtobufsE2E.ImageMessage
	97,  // 436: WAWebProtobufsE2E.TemplateMessage.FourRowTemplate.videoMessage:type_name -> WAWebProtobufsE2E.VideoMessage
	168, // 437: WAWebProtobufsE2E.TemplateMessage.FourRowTemplate.locationMessage:type_name -> WAWebProtobufsE2E.LocationMessage
	91,  // 438: WAWebProtobufsE2E.TemplateMessage.FourRowTemplate.content:type_name -> WAWebProtobufsE2E.HighlyStructuredMessage
	91,  // 439: WAWebProtobufsE2E.TemplateMessage.FourRowTemplate.footer:type_name -> WAWebProtobufsE2E.HighlyStructuredMessage
	180, // 440: WAWebProtobufsE2E.TemplateMessage.FourRowTemplate.buttons:type_name -> WAWebProtobufsE2E.TemplateButton
	91,  // 441: WAWebProtobufsE2E.TemplateButton.CallButton.displayText:type_name -> WAWebProtobufsE2E.HighlyStructuredMessage
	91,  // 442: WAWebProtobufsE2E.TemplateButton.CallButton.phoneNumber:type_name -> WAWebProtobufsE2E.HighlyStructuredMessage
	91,  // 443: WAWebProtobufsE2E.TemplateButton.URLButton.displayText:type_name -> WAWebProtobufsE2E.HighlyStructuredMessage
	91,  // 444: WAWebProtobufsE2E.TemplateButton.URLButton.URL:type_name -> WAWebProtobufsE2E.HighlyStructuredMessage
	91,  // 445: WAWebProtobufsE2E.TemplateButton.QuickReplyButton.displayText:type_name -> WAWebProtobufsE2E.HighlyStructuredMessage
	271, // 446: WAWebProtobufsE2E.MsgOpaqueData.PollVoteSnapshot.option:type_name -> WAWebProtobufsE2E.MsgOpaqueData.PollOption
	272, // 447: WAWebProtobufsE2E.MsgOpaqueData.PollVotesSnapshot.pollVotes:type_name -> WAWebProtobufsE2E.MsgOpaqueData.PollVoteSnapshot
...
func file_waE2E_WAWebProtobufsE2E_proto_init() {
	...
	file_waE2E_WAWebProtobufsE2E_proto_msgTypes[195].OneofWrappers = []any{
