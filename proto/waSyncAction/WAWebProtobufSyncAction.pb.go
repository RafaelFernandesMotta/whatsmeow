...
func (x BusinessBroadcastCampaignStatus) Enum() *BusinessBroadcastCampaignStatus {
	p := new(BusinessBroadcastCampaignStatus)
	*p = x
	return p
}

func (x BusinessBroadcastCampaignStatus) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (BusinessBroadcastCampaignStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_waSyncAction_WAWebProtobufSyncAction_proto_enumTypes[2].Descriptor()
}

func (BusinessBroadcastCampaignStatus) Type() protoreflect.EnumType {
	return &file_waSyncAction_WAWebProtobufSyncAction_proto_enumTypes[2]
}

func (x BusinessBroadcastCampaignStatus) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}
...
func (x *BusinessBroadcastCampaignStatus) UnmarshalJSON(b []byte) error {
	...
	*x = BusinessBroadcastCampaignStatus(num)
	return nil
}
...
func (PatchDebugData_Platform) Descriptor() protoreflect.EnumDescriptor {
	return file_waSyncAction_WAWebProtobufSyncAction_proto_enumTypes[23].Descriptor()
}

func (PatchDebugData_Platform) Type() protoreflect.EnumType {
	return &file_waSyncAction_WAWebProtobufSyncAction_proto_enumTypes[23]
}
...
func (x *SyncActionValue) GetBusinessBroadcastCampaignAction() *BusinessBroadcastCampaignAction {
	if x != nil {
		return x.BusinessBroadcastCampaignAction
	}
	return nil
}
...
type BusinessBroadcastCampaignAction struct {
	...
	MessageBody        *string                          `protobuf:"bytes,10,opt,name=messageBody" json:"messageBody,omitempty"`
	MediaData          []byte                           `protobuf:"bytes,11,opt,name=mediaData" json:"mediaData,omitempty"`
	MediaMetadata      *string                          `protobuf:"bytes,12,opt,name=mediaMetadata" json:"mediaMetadata,omitempty"`
	CtaButtonJson      *string                          `protobuf:"bytes,13,opt,name=ctaButtonJson" json:"ctaButtonJson,omitempty"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
func (x *BusinessBroadcastCampaignAction) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *BusinessBroadcastCampaignAction) GetAdId() string {
	if x != nil && x.AdId != nil {
		return *x.AdId
	}
	return ""
...
func (x *BusinessBroadcastCampaignAction) GetName() string {
	if x != nil && x.Name != nil {
		return *x.Name
	}
	return ""
...
func (x *BusinessBroadcastCampaignAction) GetMsgId() string {
...
func (x *BusinessBroadcastCampaignAction) GetBroadcastJid() string {
	if x != nil && x.BroadcastJid != nil {
		return *x.BroadcastJid
	}
	return ""
}

func (x *BusinessBroadcastCampaignAction) GetReservedQuota() int32 {
	if x != nil && x.ReservedQuota != nil {
...
func (x *BusinessBroadcastCampaignAction) GetScheduledTimestamp() int64 {
	if x != nil && x.ScheduledTimestamp != nil {
...
func (x *BusinessBroadcastCampaignAction) GetStatus() BusinessBroadcastCampaignStatus {
	if x != nil && x.Status != nil {
		return *x.Status
	}
...
func (x *BusinessBroadcastCampaignAction) GetMessageBody() string {
	if x != nil && x.MessageBody != nil {
		return *x.MessageBody
	}
	return ""
}

func (x *BusinessBroadcastCampaignAction) GetMediaData() []byte {
	if x != nil {
		return x.MediaData
	}
	return nil
...
func (x *BusinessBroadcastCampaignAction) GetMediaMetadata() string {
	if x != nil && x.MediaMetadata != nil {
		return *x.MediaMetadata
	}
	return ""
}

func (x *BusinessBroadcastCampaignAction) GetCtaButtonJson() string {
	if x != nil && x.CtaButtonJson != nil {
		return *x.CtaButtonJson
	}
	return ""
}
...
func (*FavoritesAction_Favorite) Descriptor() ([]byte, []int) {
	return file_waSyncAction_WAWebProtobufSyncAction_proto_rawDescGZIP(), []int{28, 0}
}
...
const file_waSyncAction_WAWebProtobufSyncAction_proto_rawDesc = "" +
	...
	"\x06weight\x18\x02 \x01(\x02R\x06weight\"\xd78\n" +
	...
	"\x11nctSaltSyncAction\x18P \x01(\v2*.WAWebProtobufSyncAction.NctSaltSyncActionR\x11nctSaltSyncAction\x12\x82\x01\n" +
	"\x1fbusinessBroadcastCampaignAction\x18Q \x01(\v28.WAWebProtobufSyncAction.BusinessBroadcastCampaignActionR\x1fbusinessBroadcastCampaignAction\"'\n" +
	...
	"\adeleted\x18\x01 \x01(\bR\adeleted\"\xfd\x03\n" +
	...
	"\x05msgId\x18\x04 \x01(\tR\x05msgId\x12\"\n" +
	"\fbroadcastJid\x18\x05 \x01(\tR\fbroadcastJid\x12$\n" +
	...
	"\x06status\x18\t \x01(\x0e28.WAWebProtobufSyncAction.BusinessBroadcastCampaignStatusR\x06status\x12 \n" +
	"\vmessageBody\x18\n" +
	" \x01(\tR\vmessageBody\x12\x1c\n" +
	"\tmediaData\x18\v \x01(\fR\tmediaData\x12$\n" +
	"\rmediaMetadata\x18\f \x01(\tR\rmediaMetadata\x12$\n" +
	"\rctaButtonJson\x18\r \x01(\tR\rctaButtonJson\"t\n" +
	...
	"\x14CRITICAL_UNBLOCK_LOW\x10\x05*\xec\x11\n" +
	...
	"\"BUSINESS_BROADCAST_CAMPAIGN_ACTION\x10Q\x12\x11\n" +
...
var file_waSyncAction_WAWebProtobufSyncAction_proto_enumTypes = make([]protoimpl.EnumInfo, 24)
var file_waSyncAction_WAWebProtobufSyncAction_proto_msgTypes = make([]protoimpl.MessageInfo, 82)
var file_waSyncAction_WAWebProtobufSyncAction_proto_goTypes = []any{
	...
	(BusinessBroadcastCampaignStatus)(0),                               // 2: WAWebProtobufSyncAction.BusinessBroadcastCampaignStatus
	(CallLogRecord_CallType)(0),                                        // 3: WAWebProtobufSyncAction.CallLogRecord.CallType
	(CallLogRecord_SilenceReason)(0),                                   // 4: WAWebProtobufSyncAction.CallLogRecord.SilenceReason
	(CallLogRecord_CallResult)(0),                                      // 5: WAWebProtobufSyncAction.CallLogRecord.CallResult
	(SettingsSyncAction_MediaQualitySetting)(0),                        // 6: WAWebProtobufSyncAction.SettingsSyncAction.MediaQualitySetting
	(SettingsSyncAction_DisplayMode)(0),                                // 7: WAWebProtobufSyncAction.SettingsSyncAction.DisplayMode
	(SettingsSyncAction_SettingKey)(0),                                 // 8: WAWebProtobufSyncAction.SettingsSyncAction.SettingKey
	(SettingsSyncAction_SettingPlatform)(0),                            // 9: WAWebProtobufSyncAction.SettingsSyncAction.SettingPlatform
	(InteractiveMessageAction_InteractiveMessageActionMode)(0),         // 10: WAWebProtobufSyncAction.InteractiveMessageAction.InteractiveMessageActionMode
	(PrivateProcessingSettingAction_PrivateProcessingStatus)(0),        // 11: WAWebProtobufSyncAction.PrivateProcessingSettingAction.PrivateProcessingStatus
	(AvatarUpdatedAction_AvatarEventType)(0),                           // 12: WAWebProtobufSyncAction.AvatarUpdatedAction.AvatarEventType
	(MaibaAIFeaturesControlAction_MaibaAIFeatureStatus)(0),             // 13: WAWebProtobufSyncAction.MaibaAIFeaturesControlAction.MaibaAIFeatureStatus
	(PaymentTosAction_PaymentNotice)(0),                                // 14: WAWebProtobufSyncAction.PaymentTosAction.PaymentNotice
	(NotificationActivitySettingAction_NotificationActivitySetting)(0), // 15: WAWebProtobufSyncAction.NotificationActivitySettingAction.NotificationActivitySetting
	(WaffleAccountLinkStateAction_AccountLinkState)(0),                 // 16: WAWebProtobufSyncAction.WaffleAccountLinkStateAction.AccountLinkState
	(MerchantPaymentPartnerAction_Status)(0),                           // 17: WAWebProtobufSyncAction.MerchantPaymentPartnerAction.Status
	(NoteEditAction_NoteType)(0),                                       // 18: WAWebProtobufSyncAction.NoteEditAction.NoteType
	(StatusPrivacyAction_StatusDistributionMode)(0),                    // 19: WAWebProtobufSyncAction.StatusPrivacyAction.StatusDistributionMode
	(MarketingMessageAction_MarketingMessagePrototypeType)(0),          // 20: WAWebProtobufSyncAction.MarketingMessageAction.MarketingMessagePrototypeType
	(UsernameChatStartModeAction_ChatStartMode)(0),                     // 21: WAWebProtobufSyncAction.UsernameChatStartModeAction.ChatStartMode
	(LabelEditAction_ListType)(0),                                      // 22: WAWebProtobufSyncAction.LabelEditAction.ListType
	(PatchDebugData_Platform)(0),                                       // 23: WAWebProtobufSyncAction.PatchDebugData.Platform
	(*CallLogRecord)(nil),                                              // 24: WAWebProtobufSyncAction.CallLogRecord
	(*SettingsSyncAction)(nil),                                         // 25: WAWebProtobufSyncAction.SettingsSyncAction
	(*InteractiveMessageAction)(nil),                                   // 26: WAWebProtobufSyncAction.InteractiveMessageAction
	(*PrivateProcessingSettingAction)(nil),                             // 27: WAWebProtobufSyncAction.PrivateProcessingSettingAction
	(*AvatarUpdatedAction)(nil),                                        // 28: WAWebProtobufSyncAction.AvatarUpdatedAction
	(*MaibaAIFeaturesControlAction)(nil),                               // 29: WAWebProtobufSyncAction.MaibaAIFeaturesControlAction
	(*PaymentTosAction)(nil),                                           // 30: WAWebProtobufSyncAction.PaymentTosAction
	(*NotificationActivitySettingAction)(nil),                          // 31: WAWebProtobufSyncAction.NotificationActivitySettingAction
	(*WaffleAccountLinkStateAction)(nil),                               // 32: WAWebProtobufSyncAction.WaffleAccountLinkStateAction
	(*MerchantPaymentPartnerAction)(nil),                               // 33: WAWebProtobufSyncAction.MerchantPaymentPartnerAction
	(*NoteEditAction)(nil),                                             // 34: WAWebProtobufSyncAction.NoteEditAction
	(*StatusPrivacyAction)(nil),                                        // 35: WAWebProtobufSyncAction.StatusPrivacyAction
	(*MarketingMessageAction)(nil),                                     // 36: WAWebProtobufSyncAction.MarketingMessageAction
	(*UsernameChatStartModeAction)(nil),                                // 37: WAWebProtobufSyncAction.UsernameChatStartModeAction
	(*LabelEditAction)(nil),                                            // 38: WAWebProtobufSyncAction.LabelEditAction
	(*PatchDebugData)(nil),                                             // 39: WAWebProtobufSyncAction.PatchDebugData
	(*RecentEmojiWeight)(nil),                                          // 40: WAWebProtobufSyncAction.RecentEmojiWeight
	(*SyncActionValue)(nil),                                            // 41: WAWebProtobufSyncAction.SyncActionValue
	(*NctSaltSyncAction)(nil),                                          // 42: WAWebProtobufSyncAction.NctSaltSyncAction
	(*AiThreadRenameAction)(nil),                                       // 43: WAWebProtobufSyncAction.AiThreadRenameAction
	(*StatusPostOptInNotificationPreferencesAction)(nil),               // 44: WAWebProtobufSyncAction.StatusPostOptInNotificationPreferencesAction
	(*BroadcastListParticipant)(nil),                                   // 45: WAWebProtobufSyncAction.BroadcastListParticipant
	(*BusinessBroadcastListAction)(nil),                                // 46: WAWebProtobufSyncAction.BusinessBroadcastListAction
	(*BusinessBroadcastAssociationAction)(nil),                         // 47: WAWebProtobufSyncAction.BusinessBroadcastAssociationAction
	(*BusinessBroadcastCampaignAction)(nil),                            // 48: WAWebProtobufSyncAction.BusinessBroadcastCampaignAction
	(*CtwaPerCustomerDataSharingAction)(nil),                           // 49: WAWebProtobufSyncAction.CtwaPerCustomerDataSharingAction
	(*OutContactAction)(nil),                                           // 50: WAWebProtobufSyncAction.OutContactAction
	(*LidContactAction)(nil),                                           // 51: WAWebProtobufSyncAction.LidContactAction
	(*FavoritesAction)(nil),                                            // 52: WAWebProtobufSyncAction.FavoritesAction
	(*PrivacySettingChannelsPersonalisedRecommendationAction)(nil),     // 53: WAWebProtobufSyncAction.PrivacySettingChannelsPersonalisedRecommendationAction
	(*PrivacySettingDisableLinkPreviewsAction)(nil),                    // 54: WAWebProtobufSyncAction.PrivacySettingDisableLinkPreviewsAction
	(*WamoUserIdentifierAction)(nil),                                   // 55: WAWebProtobufSyncAction.WamoUserIdentifierAction
	(*LockChatAction)(nil),                                             // 56: WAWebProtobufSyncAction.LockChatAction
	(*CustomPaymentMethodsAction)(nil),                                 // 57: WAWebProtobufSyncAction.CustomPaymentMethodsAction
	(*CustomPaymentMethod)(nil),                                        // 58: WAWebProtobufSyncAction.CustomPaymentMethod
	(*CustomPaymentMethodMetadata)(nil),                                // 59: WAWebProtobufSyncAction.CustomPaymentMethodMetadata
	(*PaymentInfoAction)(nil),                                          // 60: WAWebProtobufSyncAction.PaymentInfoAction
	(*LabelReorderingAction)(nil),                                      // 61: WAWebProtobufSyncAction.LabelReorderingAction
	(*DeleteIndividualCallLogAction)(nil),                              // 62: WAWebProtobufSyncAction.DeleteIndividualCallLogAction
	(*BotWelcomeRequestAction)(nil),                                    // 63: WAWebProtobufSyncAction.BotWelcomeRequestAction
	(*NewsletterSavedInterestsAction)(nil),                             // 64: WAWebProtobufSyncAction.NewsletterSavedInterestsAction
	(*MusicUserIdAction)(nil),                                          // 65: WAWebProtobufSyncAction.MusicUserIdAction
	(*UGCBot)(nil),                                                     // 66: WAWebProtobufSyncAction.UGCBot
	(*CallLogAction)(nil),                                              // 67: WAWebProtobufSyncAction.CallLogAction
	(*PrivacySettingRelayAllCalls)(nil),                                // 68: WAWebProtobufSyncAction.PrivacySettingRelayAllCalls
	(*DetectedOutcomesStatusAction)(nil),                               // 69: WAWebProtobufSyncAction.DetectedOutcomesStatusAction
	(*ExternalWebBetaAction)(nil),                                      // 70: WAWebProtobufSyncAction.ExternalWebBetaAction
	(*MarketingMessageBroadcastAction)(nil),                            // 71: WAWebProtobufSyncAction.MarketingMessageBroadcastAction
	(*PnForLidChatAction)(nil),                                         // 72: WAWebProtobufSyncAction.PnForLidChatAction
	(*ChatAssignmentOpenedStatusAction)(nil),                           // 73: WAWebProtobufSyncAction.ChatAssignmentOpenedStatusAction
	(*ChatAssignmentAction)(nil),                                       // 74: WAWebProtobufSyncAction.ChatAssignmentAction
	(*StickerAction)(nil),                                              // 75: WAWebProtobufSyncAction.StickerAction
	(*RemoveRecentStickerAction)(nil),                                  // 76: WAWebProtobufSyncAction.RemoveRecentStickerAction
	(*PrimaryVersionAction)(nil),                                       // 77: WAWebProtobufSyncAction.PrimaryVersionAction
	(*NuxAction)(nil),                                                  // 78: WAWebProtobufSyncAction.NuxAction
	(*TimeFormatAction)(nil),                                           // 79: WAWebProtobufSyncAction.TimeFormatAction
	(*UserStatusMuteAction)(nil),                                       // 80: WAWebProtobufSyncAction.UserStatusMuteAction
	(*SubscriptionAction)(nil),                                         // 81: WAWebProtobufSyncAction.SubscriptionAction
	(*AgentAction)(nil),                                                // 82: WAWebProtobufSyncAction.AgentAction
	(*AndroidUnsupportedActions)(nil),                                  // 83: WAWebProtobufSyncAction.AndroidUnsupportedActions
	(*PrimaryFeature)(nil),                                             // 84: WAWebProtobufSyncAction.PrimaryFeature
	(*KeyExpiration)(nil),                                              // 85: WAWebProtobufSyncAction.KeyExpiration
	(*SyncActionMessage)(nil),                                          // 86: WAWebProtobufSyncAction.SyncActionMessage
	(*SyncActionMessageRange)(nil),                                     // 87: WAWebProtobufSyncAction.SyncActionMessageRange
	(*UnarchiveChatsSetting)(nil),                                      // 88: WAWebProtobufSyncAction.UnarchiveChatsSetting
	(*DeleteChatAction)(nil),                                           // 89: WAWebProtobufSyncAction.DeleteChatAction
	(*ClearChatAction)(nil),                                            // 90: WAWebProtobufSyncAction.ClearChatAction
	(*MarkChatAsReadAction)(nil),                                       // 91: WAWebProtobufSyncAction.MarkChatAsReadAction
	(*DeleteMessageForMeAction)(nil),                                   // 92: WAWebProtobufSyncAction.DeleteMessageForMeAction
	(*ArchiveChatAction)(nil),                                          // 93: WAWebProtobufSyncAction.ArchiveChatAction
	(*RecentEmojiWeightsAction)(nil),                                   // 94: WAWebProtobufSyncAction.RecentEmojiWeightsAction
	(*LabelAssociationAction)(nil),                                     // 95: WAWebProtobufSyncAction.LabelAssociationAction
	(*QuickReplyAction)(nil),                                           // 96: WAWebProtobufSyncAction.QuickReplyAction
	(*LocaleSetting)(nil),                                              // 97: WAWebProtobufSyncAction.LocaleSetting
	(*PushNameSetting)(nil),                                            // 98: WAWebProtobufSyncAction.PushNameSetting
	(*PinAction)(nil),                                                  // 99: WAWebProtobufSyncAction.PinAction
	(*MuteAction)(nil),                                                 // 100: WAWebProtobufSyncAction.MuteAction
	(*ContactAction)(nil),                                              // 101: WAWebProtobufSyncAction.ContactAction
	(*StarAction)(nil),                                                 // 102: WAWebProtobufSyncAction.StarAction
	(*SyncActionData)(nil),                                             // 103: WAWebProtobufSyncAction.SyncActionData
	(*CallLogRecord_ParticipantInfo)(nil),                              // 104: WAWebProtobufSyncAction.CallLogRecord.ParticipantInfo
	(*FavoritesAction_Favorite)(nil),                                   // 105: WAWebProtobufSyncAction.FavoritesAction.Favorite
	(*waChatLockSettings.ChatLockSettings)(nil),                        // 106: WAWebProtobufsChatLockSettings.ChatLockSettings
	(*waDeviceCapabilities.DeviceCapabilities)(nil),                    // 107: WAWebProtobufsDeviceCapabilities.DeviceCapabilities
	(*waCommon.MessageKey)(nil),                                        // 108: WACommon.MessageKey
}
var file_waSyncAction_WAWebProtobufSyncAction_proto_depIdxs = []int32{
	5,   // 0: WAWebProtobufSyncAction.CallLogRecord.callResult:type_name -> WAWebProtobufSyncAction.CallLogRecord.CallResult
	4,   // 1: WAWebProtobufSyncAction.CallLogRecord.silenceReason:type_name -> WAWebProtobufSyncAction.CallLogRecord.SilenceReason
	104, // 2: WAWebProtobufSyncAction.CallLogRecord.participants:type_name -> WAWebProtobufSyncAction.CallLogRecord.ParticipantInfo
	3,   // 3: WAWebProtobufSyncAction.CallLogRecord.callType:type_name -> WAWebProtobufSyncAction.CallLogRecord.CallType
	7,   // 4: WAWebProtobufSyncAction.SettingsSyncAction.bannerNotificationDisplayMode:type_name -> WAWebProtobufSyncAction.SettingsSyncAction.DisplayMode
	7,   // 5: WAWebProtobufSyncAction.SettingsSyncAction.unreadCounterBadgeDisplayMode:type_name -> WAWebProtobufSyncAction.SettingsSyncAction.DisplayMode
	...
	10,  // 7: WAWebProtobufSyncAction.InteractiveMessageAction.type:type_name -> WAWebProtobufSyncAction.InteractiveMessageAction.InteractiveMessageActionMode
	11,  // 8: WAWebProtobufSyncAction.PrivateProcessingSettingAction.privateProcessingStatus:type_name -> WAWebProtobufSyncAction.PrivateProcessingSettingAction.PrivateProcessingStatus
	12,  // 9: WAWebProtobufSyncAction.AvatarUpdatedAction.eventType:type_name -> WAWebProtobufSyncAction.AvatarUpdatedAction.AvatarEventType
	75,  // 10: WAWebProtobufSyncAction.AvatarUpdatedAction.recentAvatarStickers:type_name -> WAWebProtobufSyncAction.StickerAction
	13,  // 11: WAWebProtobufSyncAction.MaibaAIFeaturesControlAction.aiFeatureStatus:type_name -> WAWebProtobufSyncAction.MaibaAIFeaturesControlAction.MaibaAIFeatureStatus
	14,  // 12: WAWebProtobufSyncAction.PaymentTosAction.paymentNotice:type_name -> WAWebProtobufSyncAction.PaymentTosAction.PaymentNotice
	15,  // 13: WAWebProtobufSyncAction.NotificationActivitySettingAction.notificationActivitySetting:type_name -> WAWebProtobufSyncAction.NotificationActivitySettingAction.NotificationActivitySetting
	16,  // 14: WAWebProtobufSyncAction.WaffleAccountLinkStateAction.linkState:type_name -> WAWebProtobufSyncAction.WaffleAccountLinkStateAction.AccountLinkState
	17,  // 15: WAWebProtobufSyncAction.MerchantPaymentPartnerAction.status:type_name -> WAWebProtobufSyncAction.MerchantPaymentPartnerAction.Status
	18,  // 16: WAWebProtobufSyncAction.NoteEditAction.type:type_name -> WAWebProtobufSyncAction.NoteEditAction.NoteType
	19,  // 17: WAWebProtobufSyncAction.StatusPrivacyAction.mode:type_name -> WAWebProtobufSyncAction.StatusPrivacyAction.StatusDistributionMode
	20,  // 18: WAWebProtobufSyncAction.MarketingMessageAction.type:type_name -> WAWebProtobufSyncAction.MarketingMessageAction.MarketingMessagePrototypeType
	21,  // 19: WAWebProtobufSyncAction.UsernameChatStartModeAction.chatStartMode:type_name -> WAWebProtobufSyncAction.UsernameChatStartModeAction.ChatStartMode
	22,  // 20: WAWebProtobufSyncAction.LabelEditAction.type:type_name -> WAWebProtobufSyncAction.LabelEditAction.ListType
	23,  // 21: WAWebProtobufSyncAction.PatchDebugData.senderPlatform:type_name -> WAWebProtobufSyncAction.PatchDebugData.Platform
	102, // 22: WAWebProtobufSyncAction.SyncActionValue.starAction:type_name -> WAWebProtobufSyncAction.StarAction
	101, // 23: WAWebProtobufSyncAction.SyncActionValue.contactAction:type_name -> WAWebProtobufSyncAction.ContactAction
	100, // 24: WAWebProtobufSyncAction.SyncActionValue.muteAction:type_name -> WAWebProtobufSyncAction.MuteAction
	99,  // 25: WAWebProtobufSyncAction.SyncActionValue.pinAction:type_name -> WAWebProtobufSyncAction.PinAction
	98,  // 26: WAWebProtobufSyncAction.SyncActionValue.pushNameSetting:type_name -> WAWebProtobufSyncAction.PushNameSetting
	96,  // 27: WAWebProtobufSyncAction.SyncActionValue.quickReplyAction:type_name -> WAWebProtobufSyncAction.QuickReplyAction
	94,  // 28: WAWebProtobufSyncAction.SyncActionValue.recentEmojiWeightsAction:type_name -> WAWebProtobufSyncAction.RecentEmojiWeightsAction
	38,  // 29: WAWebProtobufSyncAction.SyncActionValue.labelEditAction:type_name -> WAWebProtobufSyncAction.LabelEditAction
	95,  // 30: WAWebProtobufSyncAction.SyncActionValue.labelAssociationAction:type_name -> WAWebProtobufSyncAction.LabelAssociationAction
	97,  // 31: WAWebProtobufSyncAction.SyncActionValue.localeSetting:type_name -> WAWebProtobufSyncAction.LocaleSetting
	93,  // 32: WAWebProtobufSyncAction.SyncActionValue.archiveChatAction:type_name -> WAWebProtobufSyncAction.ArchiveChatAction
	92,  // 33: WAWebProtobufSyncAction.SyncActionValue.deleteMessageForMeAction:type_name -> WAWebProtobufSyncAction.DeleteMessageForMeAction
	85,  // 34: WAWebProtobufSyncAction.SyncActionValue.keyExpiration:type_name -> WAWebProtobufSyncAction.KeyExpiration
	91,  // 35: WAWebProtobufSyncAction.SyncActionValue.markChatAsReadAction:type_name -> WAWebProtobufSyncAction.MarkChatAsReadAction
	90,  // 36: WAWebProtobufSyncAction.SyncActionValue.clearChatAction:type_name -> WAWebProtobufSyncAction.ClearChatAction
	89,  // 37: WAWebProtobufSyncAction.SyncActionValue.deleteChatAction:type_name -> WAWebProtobufSyncAction.DeleteChatAction
	88,  // 38: WAWebProtobufSyncAction.SyncActionValue.unarchiveChatsSetting:type_name -> WAWebProtobufSyncAction.UnarchiveChatsSetting
	84,  // 39: WAWebProtobufSyncAction.SyncActionValue.primaryFeature:type_name -> WAWebProtobufSyncAction.PrimaryFeature
	83,  // 40: WAWebProtobufSyncAction.SyncActionValue.androidUnsupportedActions:type_name -> WAWebProtobufSyncAction.AndroidUnsupportedActions
	82,  // 41: WAWebProtobufSyncAction.SyncActionValue.agentAction:type_name -> WAWebProtobufSyncAction.AgentAction
	81,  // 42: WAWebProtobufSyncAction.SyncActionValue.subscriptionAction:type_name -> WAWebProtobufSyncAction.SubscriptionAction
	80,  // 43: WAWebProtobufSyncAction.SyncActionValue.userStatusMuteAction:type_name -> WAWebProtobufSyncAction.UserStatusMuteAction
	79,  // 44: WAWebProtobufSyncAction.SyncActionValue.timeFormatAction:type_name -> WAWebProtobufSyncAction.TimeFormatAction
	78,  // 45: WAWebProtobufSyncAction.SyncActionValue.nuxAction:type_name -> WAWebProtobufSyncAction.NuxAction
	77,  // 46: WAWebProtobufSyncAction.SyncActionValue.primaryVersionAction:type_name -> WAWebProtobufSyncAction.PrimaryVersionAction
	75,  // 47: WAWebProtobufSyncAction.SyncActionValue.stickerAction:type_name -> WAWebProtobufSyncAction.StickerAction
	76,  // 48: WAWebProtobufSyncAction.SyncActionValue.removeRecentStickerAction:type_name -> WAWebProtobufSyncAction.RemoveRecentStickerAction
	74,  // 49: WAWebProtobufSyncAction.SyncActionValue.chatAssignment:type_name -> WAWebProtobufSyncAction.ChatAssignmentAction
	73,  // 50: WAWebProtobufSyncAction.SyncActionValue.chatAssignmentOpenedStatus:type_name -> WAWebProtobufSyncAction.ChatAssignmentOpenedStatusAction
	72,  // 51: WAWebProtobufSyncAction.SyncActionValue.pnForLidChatAction:type_name -> WAWebProtobufSyncAction.PnForLidChatAction
	36,  // 52: WAWebProtobufSyncAction.SyncActionValue.marketingMessageAction:type_name -> WAWebProtobufSyncAction.MarketingMessageAction
	71,  // 53: WAWebProtobufSyncAction.SyncActionValue.marketingMessageBroadcastAction:type_name -> WAWebProtobufSyncAction.MarketingMessageBroadcastAction
	70,  // 54: WAWebProtobufSyncAction.SyncActionValue.externalWebBetaAction:type_name -> WAWebProtobufSyncAction.ExternalWebBetaAction
	68,  // 55: WAWebProtobufSyncAction.SyncActionValue.privacySettingRelayAllCalls:type_name -> WAWebProtobufSyncAction.PrivacySettingRelayAllCalls
	67,  // 56: WAWebProtobufSyncAction.SyncActionValue.callLogAction:type_name -> WAWebProtobufSyncAction.CallLogAction
	66,  // 57: WAWebProtobufSyncAction.SyncActionValue.ugcBot:type_name -> WAWebProtobufSyncAction.UGCBot
	35,  // 58: WAWebProtobufSyncAction.SyncActionValue.statusPrivacy:type_name -> WAWebProtobufSyncAction.StatusPrivacyAction
	63,  // 59: WAWebProtobufSyncAction.SyncActionValue.botWelcomeRequestAction:type_name -> WAWebProtobufSyncAction.BotWelcomeRequestAction
	62,  // 60: WAWebProtobufSyncAction.SyncActionValue.deleteIndividualCallLog:type_name -> WAWebProtobufSyncAction.DeleteIndividualCallLogAction
	61,  // 61: WAWebProtobufSyncAction.SyncActionValue.labelReorderingAction:type_name -> WAWebProtobufSyncAction.LabelReorderingAction
	60,  // 62: WAWebProtobufSyncAction.SyncActionValue.paymentInfoAction:type_name -> WAWebProtobufSyncAction.PaymentInfoAction
	57,  // 63: WAWebProtobufSyncAction.SyncActionValue.customPaymentMethodsAction:type_name -> WAWebProtobufSyncAction.CustomPaymentMethodsAction
	56,  // 64: WAWebProtobufSyncAction.SyncActionValue.lockChatAction:type_name -> WAWebProtobufSyncAction.LockChatAction
	106, // 65: WAWebProtobufSyncAction.SyncActionValue.chatLockSettings:type_name -> WAWebProtobufsChatLockSettings.ChatLockSettings
	55,  // 66: WAWebProtobufSyncAction.SyncActionValue.wamoUserIdentifierAction:type_name -> WAWebProtobufSyncAction.WamoUserIdentifierAction
	54,  // 67: WAWebProtobufSyncAction.SyncActionValue.privacySettingDisableLinkPreviewsAction:type_name -> WAWebProtobufSyncAction.PrivacySettingDisableLinkPreviewsAction
	107, // 68: WAWebProtobufSyncAction.SyncActionValue.deviceCapabilities:type_name -> WAWebProtobufsDeviceCapabilities.DeviceCapabilities
	34,  // 69: WAWebProtobufSyncAction.SyncActionValue.noteEditAction:type_name -> WAWebProtobufSyncAction.NoteEditAction
	52,  // 70: WAWebProtobufSyncAction.SyncActionValue.favoritesAction:type_name -> WAWebProtobufSyncAction.FavoritesAction
	33,  // 71: WAWebProtobufSyncAction.SyncActionValue.merchantPaymentPartnerAction:type_name -> WAWebProtobufSyncAction.MerchantPaymentPartnerAction
	32,  // 72: WAWebProtobufSyncAction.SyncActionValue.waffleAccountLinkStateAction:type_name -> WAWebProtobufSyncAction.WaffleAccountLinkStateAction
	37,  // 73: WAWebProtobufSyncAction.SyncActionValue.usernameChatStartMode:type_name -> WAWebProtobufSyncAction.UsernameChatStartModeAction
	31,  // 74: WAWebProtobufSyncAction.SyncActionValue.notificationActivitySettingAction:type_name -> WAWebProtobufSyncAction.NotificationActivitySettingAction
	51,  // 75: WAWebProtobufSyncAction.SyncActionValue.lidContactAction:type_name -> WAWebProtobufSyncAction.LidContactAction
	49,  // 76: WAWebProtobufSyncAction.SyncActionValue.ctwaPerCustomerDataSharingAction:type_name -> WAWebProtobufSyncAction.CtwaPerCustomerDataSharingAction
	30,  // 77: WAWebProtobufSyncAction.SyncActionValue.paymentTosAction:type_name -> WAWebProtobufSyncAction.PaymentTosAction
	53,  // 78: WAWebProtobufSyncAction.SyncActionValue.privacySettingChannelsPersonalisedRecommendationAction:type_name -> WAWebProtobufSyncAction.PrivacySettingChannelsPersonalisedRecommendationAction
	69,  // 79: WAWebProtobufSyncAction.SyncActionValue.detectedOutcomesStatusAction:type_name -> WAWebProtobufSyncAction.DetectedOutcomesStatusAction
	29,  // 80: WAWebProtobufSyncAction.SyncActionValue.maibaAiFeaturesControlAction:type_name -> WAWebProtobufSyncAction.MaibaAIFeaturesControlAction
	46,  // 81: WAWebProtobufSyncAction.SyncActionValue.businessBroadcastListAction:type_name -> WAWebProtobufSyncAction.BusinessBroadcastListAction
	65,  // 82: WAWebProtobufSyncAction.SyncActionValue.musicUserIDAction:type_name -> WAWebProtobufSyncAction.MusicUserIdAction
	44,  // 83: WAWebProtobufSyncAction.SyncActionValue.statusPostOptInNotificationPreferencesAction:type_name -> WAWebProtobufSyncAction.StatusPostOptInNotificationPreferencesAction
	28,  // 84: WAWebProtobufSyncAction.SyncActionValue.avatarUpdatedAction:type_name -> WAWebProtobufSyncAction.AvatarUpdatedAction
	27,  // 85: WAWebProtobufSyncAction.SyncActionValue.privateProcessingSettingAction:type_name -> WAWebProtobufSyncAction.PrivateProcessingSettingAction
	64,  // 86: WAWebProtobufSyncAction.SyncActionValue.newsletterSavedInterestsAction:type_name -> WAWebProtobufSyncAction.NewsletterSavedInterestsAction
	43,  // 87: WAWebProtobufSyncAction.SyncActionValue.aiThreadRenameAction:type_name -> WAWebProtobufSyncAction.AiThreadRenameAction
	26,  // 88: WAWebProtobufSyncAction.SyncActionValue.interactiveMessageAction:type_name -> WAWebProtobufSyncAction.InteractiveMessageAction
	25,  // 89: WAWebProtobufSyncAction.SyncActionValue.settingsSyncAction:type_name -> WAWebProtobufSyncAction.SettingsSyncAction
	50,  // 90: WAWebProtobufSyncAction.SyncActionValue.outContactAction:type_name -> WAWebProtobufSyncAction.OutContactAction
	42,  // 91: WAWebProtobufSyncAction.SyncActionValue.nctSaltSyncAction:type_name -> WAWebProtobufSyncAction.NctSaltSyncAction
	48,  // 92: WAWebProtobufSyncAction.SyncActionValue.businessBroadcastCampaignAction:type_name -> WAWebProtobufSyncAction.BusinessBroadcastCampaignAction
	45,  // 93: WAWebProtobufSyncAction.BusinessBroadcastListAction.participants:type_name -> WAWebProtobufSyncAction.BroadcastListParticipant
	2,   // 94: WAWebProtobufSyncAction.BusinessBroadcastCampaignAction.status:type_name -> WAWebProtobufSyncAction.BusinessBroadcastCampaignStatus
	105, // 95: WAWebProtobufSyncAction.FavoritesAction.favorites:type_name -> WAWebProtobufSyncAction.FavoritesAction.Favorite
	58,  // 96: WAWebProtobufSyncAction.CustomPaymentMethodsAction.customPaymentMethods:type_name -> WAWebProtobufSyncAction.CustomPaymentMethod
	59,  // 97: WAWebProtobufSyncAction.CustomPaymentMethod.metadata:type_name -> WAWebProtobufSyncAction.CustomPaymentMethodMetadata
	24,  // 98: WAWebProtobufSyncAction.CallLogAction.callLogRecord:type_name -> WAWebProtobufSyncAction.CallLogRecord
	108, // 99: WAWebProtobufSyncAction.SyncActionMessage.key:type_name -> WACommon.MessageKey
	86,  // 100: WAWebProtobufSyncAction.SyncActionMessageRange.messages:type_name -> WAWebProtobufSyncAction.SyncActionMessage
	87,  // 101: WAWebProtobufSyncAction.DeleteChatAction.messageRange:type_name -> WAWebProtobufSyncAction.SyncActionMessageRange
	87,  // 102: WAWebProtobufSyncAction.ClearChatAction.messageRange:type_name -> WAWebProtobufSyncAction.SyncActionMessageRange
	87,  // 103: WAWebProtobufSyncAction.MarkChatAsReadAction.messageRange:type_name -> WAWebProtobufSyncAction.SyncActionMessageRange
	87,  // 104: WAWebProtobufSyncAction.ArchiveChatAction.messageRange:type_name -> WAWebProtobufSyncAction.SyncActionMessageRange
	40,  // 105: WAWebProtobufSyncAction.RecentEmojiWeightsAction.weights:type_name -> WAWebProtobufSyncAction.RecentEmojiWeight
	41,  // 106: WAWebProtobufSyncAction.SyncActionData.value:type_name -> WAWebProtobufSyncAction.SyncActionValue
	5,   // 107: WAWebProtobufSyncAction.CallLogRecord.ParticipantInfo.callResult:type_name -> WAWebProtobufSyncAction.CallLogRecord.CallResult
