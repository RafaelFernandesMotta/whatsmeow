...
const (
	...
	LimitSharing_DEPRECATION             LimitSharing_Trigger = 4
)
...
const file_waCommon_WACommon_proto_rawDesc = "" +
	...
	"\aversion\x18\x02 \x01(\x05R\aversion\"\xc5\x02\n" +
	"\fLimitSharing\x12&\n" +
	...
	"\rinitiatedByMe\x18\x04 \x01(\bR\rinitiatedByMe\"i\n" +
	"\aTrigger\x12\v\n" +
	"\aUNKNOWN\x10\x00\x12\x10\n" +
	"\fCHAT_SETTING\x10\x01\x12\x1b\n" +
	"\x17BIZ_SUPPORTS_FB_HOSTING\x10\x02\x12\x11\n" +
	"\rUNKNOWN_GROUP\x10\x03\x12\x0f\n" +
	"\vDEPRECATION\x10\x04*F\n" +
